...
public:
    ...
    const AtomString beforematchEvent;
    ...
    const AtomString scrollendEvent;
    ...
    std::array<const AtomString, 326> allEventNames() const;
    WTF::HashSet<AtomString> allEventHandlerNames() const;
