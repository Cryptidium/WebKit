...
public:
    ...
    // Custom enabled-by
    static bool shouldEnableWebkitRequestFullScreen(ScriptExecutionContext*);
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, Element& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
