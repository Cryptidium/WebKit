...
public:
    ...
    static JSDOMException* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<DOMException>&& impl)
    {
        ...
        JSDOMException* ptr = new (NotNull, JSC::allocateCell<JSDOMException>(vm)) JSDOMException(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, DOMException& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
