...
template<> ConversionResult<IDLDictionary<DelayOptions>> convertDictionary<DelayOptions>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    auto delayTimeConversionResult = convertOptionalWithDefault<IDLDouble>(lexicalGlobalObject, delayTimeValue, [&]() -> ConversionResult<IDLDouble> { return Converter<IDLDouble>::ReturnType { 0 }; });
    if (delayTimeConversionResult.hasException(throwScope)) [[unlikely]]
        return ConversionResultException { };
    result.delayTime = delayTimeConversionResult.releaseReturnValue();
    ...
    auto maxDelayTimeConversionResult = convertOptionalWithDefault<IDLDouble>(lexicalGlobalObject, maxDelayTimeValue, [&]() -> ConversionResult<IDLDouble> { return Converter<IDLDouble>::ReturnType { 1 }; });
    if (maxDelayTimeConversionResult.hasException(throwScope)) [[unlikely]]
        return ConversionResultException { };
    result.maxDelayTime = maxDelayTimeConversionResult.releaseReturnValue();
    return result;
}
