...
public:
    ...
    static JSDOMFormData* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<DOMFormData>&& impl)
    {
        ...
        JSDOMFormData* ptr = new (NotNull, JSC::allocateCell<JSDOMFormData>(vm)) JSDOMFormData(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, DOMFormData& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
