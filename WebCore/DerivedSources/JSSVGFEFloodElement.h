...
public:
    ...
    static JSSVGFEFloodElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEFloodElement>&& impl)
    {
        ...
        JSSVGFEFloodElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEFloodElement>(vm)) JSSVGFEFloodElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEFloodElement> protectedWrapped() const;
