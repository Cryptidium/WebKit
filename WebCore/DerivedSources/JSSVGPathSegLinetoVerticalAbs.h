...
public:
    ...
    static JSSVGPathSegLinetoVerticalAbs* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegLinetoVerticalAbs>&& impl)
    {
        ...
        JSSVGPathSegLinetoVerticalAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoVerticalAbs>(vm)) JSSVGPathSegLinetoVerticalAbs(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPathSegLinetoVerticalAbs> protectedWrapped() const;
