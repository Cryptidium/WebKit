...
public:
    ...
    static JSRTCPeerConnection* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<RTCPeerConnection>&& impl)
    {
        ...
        JSRTCPeerConnection* ptr = new (NotNull, JSC::allocateCell<JSRTCPeerConnection>(vm)) JSRTCPeerConnection(structure, *globalObject, WTFMove(impl));
    ...
    Ref<RTCPeerConnection> protectedWrapped() const;
...
class WEBCORE_EXPORT JSRTCPeerConnectionOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, RTCPeerConnection& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> ConversionResult<IDLDictionary<RTCPeerConnection::DataChannelInit>> convertDictionary<RTCPeerConnection::DataChannelInit>(JSC::JSGlobalObject&, JSC::JSValue);

#endif

#if ENABLE(WEB_RTC)

template<> ConversionResult<IDLDictionary<RTCPeerConnection::CertificateParameters>> convertDictionary<RTCPeerConnection::CertificateParameters>(JSC::JSGlobalObject&, JSC::JSValue);

#endif

#if ENABLE(WEB_RTC)

template<> ConversionResult<IDLDictionary<RTCRtpTransceiverInit>> convertDictionary<RTCRtpTransceiverInit>(JSC::JSGlobalObject&, JSC::JSValue);
