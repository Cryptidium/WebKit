...
public:
    ...
    static JSHTMLAreaElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLAreaElement>&& impl)
    {
        ...
        JSHTMLAreaElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLAreaElement>(vm)) JSHTMLAreaElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLAreaElement> protectedWrapped() const;
