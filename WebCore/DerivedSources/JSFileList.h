...
public:
    ...
    static JSFileList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<FileList>&& impl)
    {
        ...
        JSFileList* ptr = new (NotNull, JSC::allocateCell<JSFileList>(vm)) JSFileList(structure, *globalObject, WTFMove(impl));
...
class JSFileListOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, FileList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
