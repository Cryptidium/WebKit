...
public:
    ...
    static JSDOMStringList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<DOMStringList>&& impl)
    {
        ...
        JSDOMStringList* ptr = new (NotNull, JSC::allocateCell<JSDOMStringList>(vm)) JSDOMStringList(structure, *globalObject, WTFMove(impl));
...
class JSDOMStringListOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, DOMStringList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
