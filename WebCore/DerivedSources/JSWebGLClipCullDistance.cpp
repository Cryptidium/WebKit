...
static const std::array<HashTableValue, 11> JSWebGLClipCullDistancePrototypeTableValues {
    HashTableValue { "MAX_CLIP_DISTANCES_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x0D32 } },
    HashTableValue { "MAX_CULL_DISTANCES_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x82F9 } },
    HashTableValue { "MAX_COMBINED_CLIP_AND_CULL_DISTANCES_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x82FA } },
    HashTableValue { "CLIP_DISTANCE0_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x3000 } },
    HashTableValue { "CLIP_DISTANCE1_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x3001 } },
    HashTableValue { "CLIP_DISTANCE2_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x3002 } },
    HashTableValue { "CLIP_DISTANCE3_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x3003 } },
    HashTableValue { "CLIP_DISTANCE4_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x3004 } },
    HashTableValue { "CLIP_DISTANCE5_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x3005 } },
    HashTableValue { "CLIP_DISTANCE6_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x3006 } },
    HashTableValue { "CLIP_DISTANCE7_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x3007 } },
};
...
{
    return WebCore::subspaceForImpl<JSWebGLClipCullDistance, UseCustomHeapCellType::No>(vm, "JSWebGLClipCullDistance"_s,
...
bool JSWebGLClipCullDistanceOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, ASCIILiteral* reason)
{
    auto* jsWebGLClipCullDistance = jsCast<JSWebGLClipCullDistance*>(handle.slot()->asCell());
    auto& owner = jsWebGLClipCullDistance->wrapped();
    if (reason) [[unlikely]]
        *reason = "Reachable from jsWebGLClipCullDistance"_s;
...
void JSWebGLClipCullDistanceOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsWebGLClipCullDistance->protectedWrapped().ptr(), jsWebGLClipCullDistance);
}
...
#endif
template<std::same_as<WebGLClipCullDistance> T>
static inline void verifyVTable(WebGLClipCullDistance* ptr) 
{
...
{
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<WebGLClipCullDistance>(impl.ptr());
#endif
