...
public:
    ...
    static JSHTMLFieldSetElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLFieldSetElement>&& impl)
    {
        ...
        JSHTMLFieldSetElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLFieldSetElement>(vm)) JSHTMLFieldSetElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLFieldSetElement> protectedWrapped() const;
