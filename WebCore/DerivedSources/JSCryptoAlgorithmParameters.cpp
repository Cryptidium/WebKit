...
template<> ConversionResult<IDLDictionary<CryptoAlgorithmParameters>> convertDictionary<CryptoAlgorithmParameters>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
