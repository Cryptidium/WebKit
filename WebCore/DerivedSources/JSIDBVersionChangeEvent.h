...
public:
    ...
    static JSIDBVersionChangeEvent* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<IDBVersionChangeEvent>&& impl)
    {
        ...
        JSIDBVersionChangeEvent* ptr = new (NotNull, JSC::allocateCell<JSIDBVersionChangeEvent>(vm)) JSIDBVersionChangeEvent(structure, *globalObject, WTFMove(impl));
    ...
    Ref<IDBVersionChangeEvent> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, IDBVersionChangeEvent& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> ConversionResult<IDLDictionary<IDBVersionChangeEvent::Init>> convertDictionary<IDBVersionChangeEvent::Init>(JSC::JSGlobalObject&, JSC::JSValue);
