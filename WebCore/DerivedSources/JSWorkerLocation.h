...
public:
    ...
    static JSWorkerLocation* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<WorkerLocation>&& impl)
    {
        ...
        JSWorkerLocation* ptr = new (NotNull, JSC::allocateCell<JSWorkerLocation>(vm)) JSWorkerLocation(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, WorkerLocation& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
