...
{
    return WebCore::subspaceForImpl<JSOESTextureHalfFloatLinear, UseCustomHeapCellType::No>(vm, "JSOESTextureHalfFloatLinear"_s,
...
#endif
template<std::same_as<OESTextureHalfFloatLinear> T>
static inline void verifyVTable(OESTextureHalfFloatLinear* ptr) 
{
