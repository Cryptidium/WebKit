...
public:
    ...
    static JSSVGPathSegArcAbs* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegArcAbs>&& impl)
    {
        ...
        JSSVGPathSegArcAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegArcAbs>(vm)) JSSVGPathSegArcAbs(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPathSegArcAbs> protectedWrapped() const;
