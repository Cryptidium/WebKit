...
public:
    ...
    static JSPerformance* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<Performance>&& impl)
    {
        ...
        JSPerformance* ptr = new (NotNull, JSC::allocateCell<JSPerformance>(vm)) JSPerformance(structure, *globalObject, WTFMove(impl));
    ...
    Ref<Performance> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, Performance& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
