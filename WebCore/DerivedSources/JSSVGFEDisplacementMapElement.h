...
public:
    ...
    static JSSVGFEDisplacementMapElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEDisplacementMapElement>&& impl)
    {
        ...
        JSSVGFEDisplacementMapElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEDisplacementMapElement>(vm)) JSSVGFEDisplacementMapElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEDisplacementMapElement> protectedWrapped() const;
