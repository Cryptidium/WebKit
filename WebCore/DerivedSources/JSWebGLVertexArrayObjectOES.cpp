...
{
    return WebCore::subspaceForImpl<JSWebGLVertexArrayObjectOES, UseCustomHeapCellType::No>(vm, "JSWebGLVertexArrayObjectOES"_s,
...
bool JSWebGLVertexArrayObjectOESOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, ASCIILiteral* reason)
{
    ...
    if (reason) [[unlikely]]
        *reason = "Reachable from WebGLVertexArrayObjectOES"_s;
...
void JSWebGLVertexArrayObjectOESOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsWebGLVertexArrayObjectOES->protectedWrapped().ptr(), jsWebGLVertexArrayObjectOES);
}
...
#endif
template<std::same_as<WebGLVertexArrayObjectOES> T>
static inline void verifyVTable(WebGLVertexArrayObjectOES* ptr) 
{
...
{
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<WebGLVertexArrayObjectOES>(impl.ptr());
#endif
