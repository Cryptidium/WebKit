...
public:
    ...
    static JSHTMLStyleElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLStyleElement>&& impl)
    {
        ...
        JSHTMLStyleElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLStyleElement>(vm)) JSHTMLStyleElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLStyleElement> protectedWrapped() const;
