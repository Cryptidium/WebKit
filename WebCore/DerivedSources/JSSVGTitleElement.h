...
public:
    ...
    static JSSVGTitleElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGTitleElement>&& impl)
    {
        ...
        JSSVGTitleElement* ptr = new (NotNull, JSC::allocateCell<JSSVGTitleElement>(vm)) JSSVGTitleElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGTitleElement> protectedWrapped() const;
