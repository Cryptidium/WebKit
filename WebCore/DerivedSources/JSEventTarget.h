...
class WEBCORE_EXPORT JSEventTarget : public JSDOMWrapper<EventTarget> {
public:
...
class WEBCORE_EXPORT JSEventTargetOwner final : public JSC::WeakHandleOwner {
public:
...
WEBCORE_EXPORT JSC::JSValue toJS(JSC::JSGlobalObject*, JSDOMGlobalObject*, EventTarget&);
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, EventTarget& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
