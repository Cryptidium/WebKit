...
{
    static constexpr std::array<std::pair<ComparableASCIILiteral, EndingType>, 2> mappings {
        std::pair<ComparableASCIILiteral, EndingType> { "native"_s, EndingType::Native },
        std::pair<ComparableASCIILiteral, EndingType> { "transparent"_s, EndingType::Transparent },
    };
