...
public:
    ...
    static JSSVGGradientElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGGradientElement>&& impl)
    {
        ...
        JSSVGGradientElement* ptr = new (NotNull, JSC::allocateCell<JSSVGGradientElement>(vm)) JSSVGGradientElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGGradientElement> protectedWrapped() const;
