...
template<> ConversionResult<IDLDictionary<StructuredSerializeOptions>> convertDictionary<StructuredSerializeOptions>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
