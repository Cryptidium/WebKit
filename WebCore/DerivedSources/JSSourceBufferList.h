...
public:
    ...
    static JSSourceBufferList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SourceBufferList>&& impl)
    {
        ...
        JSSourceBufferList* ptr = new (NotNull, JSC::allocateCell<JSSourceBufferList>(vm)) JSSourceBufferList(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SourceBufferList> protectedWrapped() const;
...
class JSSourceBufferListOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, SourceBufferList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
