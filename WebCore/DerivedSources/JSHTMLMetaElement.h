...
public:
    ...
    static JSHTMLMetaElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLMetaElement>&& impl)
    {
        ...
        JSHTMLMetaElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLMetaElement>(vm)) JSHTMLMetaElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLMetaElement> protectedWrapped() const;
