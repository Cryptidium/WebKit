...
template<> ConversionResult<IDLDictionary<PaymentItem>> convertDictionary<PaymentItem>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (amountValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "amount"_s, "PaymentItem"_s, "PaymentCurrencyAmount"_s);
        return ConversionResultException { };
    }
    ...
    if (labelValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "label"_s, "PaymentItem"_s, "DOMString"_s);
        return ConversionResultException { };
    }
    ...
    auto pendingConversionResult = convertOptionalWithDefault<IDLBoolean>(lexicalGlobalObject, pendingValue, [&]() -> ConversionResult<IDLBoolean> { return Converter<IDLBoolean>::ReturnType { false }; });
    if (pendingConversionResult.hasException(throwScope)) [[unlikely]]
        return ConversionResultException { };
    result.pending = pendingConversionResult.releaseReturnValue();
    return result;
}
