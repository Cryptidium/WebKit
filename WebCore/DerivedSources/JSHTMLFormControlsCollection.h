...
public:
    ...
    static JSHTMLFormControlsCollection* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLFormControlsCollection>&& impl)
    {
        ...
        JSHTMLFormControlsCollection* ptr = new (NotNull, JSC::allocateCell<JSHTMLFormControlsCollection>(vm)) JSHTMLFormControlsCollection(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLFormControlsCollection> protectedWrapped() const;
...
class JSHTMLFormControlsCollectionOwner final : public JSC::WeakHandleOwner {
public:
