...
public:
    ...
    static JSHTMLButtonElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLButtonElement>&& impl)
    {
        ...
        JSHTMLButtonElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLButtonElement>(vm)) JSHTMLButtonElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLButtonElement> protectedWrapped() const;
