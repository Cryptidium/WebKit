...
public:
    ...
    static JSBeforeUnloadEvent* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<BeforeUnloadEvent>&& impl)
    {
        ...
        JSBeforeUnloadEvent* ptr = new (NotNull, JSC::allocateCell<JSBeforeUnloadEvent>(vm)) JSBeforeUnloadEvent(structure, *globalObject, WTFMove(impl));
    ...
    Ref<BeforeUnloadEvent> protectedWrapped() const;
