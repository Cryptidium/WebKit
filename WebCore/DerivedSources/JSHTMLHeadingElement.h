...
public:
    ...
    static JSHTMLHeadingElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLHeadingElement>&& impl)
    {
        ...
        JSHTMLHeadingElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLHeadingElement>(vm)) JSHTMLHeadingElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLHeadingElement> protectedWrapped() const;
