...
template<> ConversionResult<IDLDictionary<ChannelMergerOptions>> convertDictionary<ChannelMergerOptions>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    auto numberOfInputsConversionResult = convertOptionalWithDefault<IDLUnsignedLong>(lexicalGlobalObject, numberOfInputsValue, [&]() -> ConversionResult<IDLUnsignedLong> { return Converter<IDLUnsignedLong>::ReturnType { 6 }; });
