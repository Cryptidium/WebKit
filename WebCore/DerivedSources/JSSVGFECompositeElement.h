...
public:
    ...
    static JSSVGFECompositeElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFECompositeElement>&& impl)
    {
        ...
        JSSVGFECompositeElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFECompositeElement>(vm)) JSSVGFECompositeElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFECompositeElement> protectedWrapped() const;
