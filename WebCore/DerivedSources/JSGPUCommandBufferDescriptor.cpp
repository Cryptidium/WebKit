...
template<> ConversionResult<IDLDictionary<GPUCommandBufferDescriptor>> convertDictionary<GPUCommandBufferDescriptor>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
