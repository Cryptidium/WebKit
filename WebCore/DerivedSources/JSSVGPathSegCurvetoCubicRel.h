...
public:
    ...
    static JSSVGPathSegCurvetoCubicRel* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegCurvetoCubicRel>&& impl)
    {
        ...
        JSSVGPathSegCurvetoCubicRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoCubicRel>(vm)) JSSVGPathSegCurvetoCubicRel(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPathSegCurvetoCubicRel> protectedWrapped() const;
