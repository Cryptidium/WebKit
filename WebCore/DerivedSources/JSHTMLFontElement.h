...
public:
    ...
    static JSHTMLFontElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLFontElement>&& impl)
    {
        ...
        JSHTMLFontElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLFontElement>(vm)) JSHTMLFontElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLFontElement> protectedWrapped() const;
