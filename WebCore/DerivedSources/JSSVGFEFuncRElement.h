...
public:
    ...
    static JSSVGFEFuncRElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEFuncRElement>&& impl)
    {
        ...
        JSSVGFEFuncRElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEFuncRElement>(vm)) JSSVGFEFuncRElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEFuncRElement> protectedWrapped() const;
