...
template<> ConversionResult<IDLDictionary<ConvolverOptions>> convertDictionary<ConvolverOptions>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
