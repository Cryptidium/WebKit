...
public:
    ...
    static JSTransformStreamDefaultController* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        ...
        JSTransformStreamDefaultController* ptr = new (NotNull, JSC::allocateCell<JSTransformStreamDefaultController>(vm)) JSTransformStreamDefaultController(structure, *globalObject);
