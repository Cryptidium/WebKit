...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSNotificationPermissionCallback::invoke(typename IDLEnumeration<NotificationPermission>::ParameterType permission)
{
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSNotificationPermissionCallback::invokeRethrowingException(typename IDLEnumeration<NotificationPermission>::ParameterType permission)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
