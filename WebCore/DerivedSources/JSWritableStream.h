...
public:
    ...
    static JSWritableStream* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<WritableStream>&& impl)
    {
        ...
        JSWritableStream* ptr = new (NotNull, JSC::allocateCell<JSWritableStream>(vm)) JSWritableStream(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, WritableStream& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
