...
public:
    ...
    static JSSVGFETileElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFETileElement>&& impl)
    {
        ...
        JSSVGFETileElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFETileElement>(vm)) JSSVGFETileElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFETileElement> protectedWrapped() const;
