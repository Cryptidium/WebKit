...
public:
    ...
    static JSSVGPathSegLinetoRel* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegLinetoRel>&& impl)
    {
        ...
        JSSVGPathSegLinetoRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoRel>(vm)) JSSVGPathSegLinetoRel(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPathSegLinetoRel> protectedWrapped() const;
