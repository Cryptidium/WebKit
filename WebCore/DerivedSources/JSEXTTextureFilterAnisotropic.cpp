...
static const std::array<HashTableValue, 2> JSEXTTextureFilterAnisotropicPrototypeTableValues {
    HashTableValue { "TEXTURE_MAX_ANISOTROPY_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x84FE } },
    HashTableValue { "MAX_TEXTURE_MAX_ANISOTROPY_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x84FF } },
};
...
{
    return WebCore::subspaceForImpl<JSEXTTextureFilterAnisotropic, UseCustomHeapCellType::No>(vm, "JSEXTTextureFilterAnisotropic"_s,
...
#endif
template<std::same_as<EXTTextureFilterAnisotropic> T>
static inline void verifyVTable(EXTTextureFilterAnisotropic* ptr) 
{
