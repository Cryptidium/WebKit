...
static const std::array<HashTableValue, 3> JSByteLengthQueuingStrategyPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsByteLengthQueuingStrategyConstructor, 0 } },
    HashTableValue { "highWaterMark"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::Accessor | JSC::PropertyAttribute::Builtin, NoIntrinsic, { HashTableValue::BuiltinAccessorType, byteLengthQueuingStrategyHighWaterMarkCodeGenerator, 0 } },
    HashTableValue { "size"_s, static_cast<unsigned>(JSC::PropertyAttribute::Builtin), NoIntrinsic, { HashTableValue::BuiltinGeneratorType, byteLengthQueuingStrategySizeCodeGenerator, 0 } },
};
...
{
    return WebCore::subspaceForImpl<JSByteLengthQueuingStrategy, UseCustomHeapCellType::No>(vm, "JSByteLengthQueuingStrategy"_s,
