...
public:
    ...
    static JSTextTrackCueList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<TextTrackCueList>&& impl)
    {
        ...
        JSTextTrackCueList* ptr = new (NotNull, JSC::allocateCell<JSTextTrackCueList>(vm)) JSTextTrackCueList(structure, *globalObject, WTFMove(impl));
...
class JSTextTrackCueListOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, TextTrackCueList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
