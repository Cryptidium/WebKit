...
{
    static constexpr std::array<std::pair<ComparableASCIILiteral, GPUPowerPreference>, 2> mappings {
        std::pair<ComparableASCIILiteral, GPUPowerPreference> { "high-performance"_s, GPUPowerPreference::HighPerformance },
        std::pair<ComparableASCIILiteral, GPUPowerPreference> { "low-power"_s, GPUPowerPreference::LowPower },
    };
