...
template<> ConversionResult<IDLDictionary<CaretPositionFromPointOptions>> convertDictionary<CaretPositionFromPointOptions>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    CaretPositionFromPointOptions result;
