...
public:
    ...
    static JSHTMLParagraphElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLParagraphElement>&& impl)
    {
        ...
        JSHTMLParagraphElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLParagraphElement>(vm)) JSHTMLParagraphElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLParagraphElement> protectedWrapped() const;
