...
public:
    ...
    static JSSVGFEBlendElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEBlendElement>&& impl)
    {
        ...
        JSSVGFEBlendElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEBlendElement>(vm)) JSSVGFEBlendElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEBlendElement> protectedWrapped() const;
