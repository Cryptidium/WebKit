...
JSC::JSObject* convertDictionaryToJS(JSC::JSGlobalObject& lexicalGlobalObject, JSDOMGlobalObject& globalObject, const MediaSettingsRange& dictionary)
{
    ...
    if (!IDLDouble::isNullValue(dictionary.step)) {
        auto stepValue = toJS<IDLDouble>(lexicalGlobalObject, throwScope, IDLDouble::extractValueFromNullable(dictionary.step));
        RETURN_IF_EXCEPTION(throwScope, { });
        result->putDirect(vm, JSC::Identifier::fromString(vm, "step"_s), stepValue);
    }
    return result;
}
