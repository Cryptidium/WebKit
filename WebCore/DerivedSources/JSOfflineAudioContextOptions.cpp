...
template<> ConversionResult<IDLDictionary<OfflineAudioContextOptions>> convertDictionary<OfflineAudioContextOptions>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    OfflineAudioContextOptions result;
    JSValue lengthValue;
    ...
    if (lengthValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "length"_s, "OfflineAudioContextOptions"_s, "unsigned long"_s);
        return ConversionResultException { };
    }
    ...
    if (sampleRateValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "sampleRate"_s, "OfflineAudioContextOptions"_s, "float"_s);
        return ConversionResultException { };
    }
