...
{
    static constexpr std::array<std::pair<ComparableASCIILiteral, CanvasFillRule>, 2> mappings {
        std::pair<ComparableASCIILiteral, CanvasFillRule> { "evenodd"_s, CanvasFillRule::Evenodd },
        std::pair<ComparableASCIILiteral, CanvasFillRule> { "nonzero"_s, CanvasFillRule::Nonzero },
    };
...
template<> ASCIILiteral expectedEnumerationValues<CanvasFillRule>()
{
    return "\"nonzero\", \"evenodd\""_s;
}
