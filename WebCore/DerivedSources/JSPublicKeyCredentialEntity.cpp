...
#include "JSPublicKeyCredentialEntity.h"
...
template<> ConversionResult<IDLDictionary<PublicKeyCredentialEntity>> convertDictionary<PublicKeyCredentialEntity>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    PublicKeyCredentialEntity result;
    JSValue iconValue;
    ...
    if (nameValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "name"_s, "PublicKeyCredentialEntity"_s, "DOMString"_s);
        return ConversionResultException { };
    }
