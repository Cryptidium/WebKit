...
public:
    ...
    static JSSVGRadialGradientElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGRadialGradientElement>&& impl)
    {
        ...
        JSSVGRadialGradientElement* ptr = new (NotNull, JSC::allocateCell<JSSVGRadialGradientElement>(vm)) JSSVGRadialGradientElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGRadialGradientElement> protectedWrapped() const;
