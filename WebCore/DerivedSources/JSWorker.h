...
public:
    ...
    static JSWorker* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<Worker>&& impl)
    {
        ...
        JSWorker* ptr = new (NotNull, JSC::allocateCell<JSWorker>(vm)) JSWorker(structure, *globalObject, WTFMove(impl));
    ...
    Ref<Worker> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, Worker& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
