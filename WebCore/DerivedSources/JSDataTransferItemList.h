...
public:
    ...
    static JSDataTransferItemList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<DataTransferItemList>&& impl)
    {
        ...
        JSDataTransferItemList* ptr = new (NotNull, JSC::allocateCell<JSDataTransferItemList>(vm)) JSDataTransferItemList(structure, *globalObject, WTFMove(impl));
...
class JSDataTransferItemListOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, DataTransferItemList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
