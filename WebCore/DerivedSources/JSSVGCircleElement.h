...
public:
    ...
    static JSSVGCircleElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGCircleElement>&& impl)
    {
        ...
        JSSVGCircleElement* ptr = new (NotNull, JSC::allocateCell<JSSVGCircleElement>(vm)) JSSVGCircleElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGCircleElement> protectedWrapped() const;
