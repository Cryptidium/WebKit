...
public:
    ...
    static JSSVGPathSegLinetoVerticalRel* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegLinetoVerticalRel>&& impl)
    {
        ...
        JSSVGPathSegLinetoVerticalRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoVerticalRel>(vm)) JSSVGPathSegLinetoVerticalRel(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPathSegLinetoVerticalRel> protectedWrapped() const;
