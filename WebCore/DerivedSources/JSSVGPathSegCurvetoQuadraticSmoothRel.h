...
public:
    ...
    static JSSVGPathSegCurvetoQuadraticSmoothRel* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegCurvetoQuadraticSmoothRel>&& impl)
    {
        ...
        JSSVGPathSegCurvetoQuadraticSmoothRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoQuadraticSmoothRel>(vm)) JSSVGPathSegCurvetoQuadraticSmoothRel(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPathSegCurvetoQuadraticSmoothRel> protectedWrapped() const;
