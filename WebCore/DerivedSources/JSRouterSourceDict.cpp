...
template<> ConversionResult<IDLDictionary<RouterSourceDict>> convertDictionary<RouterSourceDict>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
