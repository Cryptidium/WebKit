...
static const std::array<HashTableValue, 3> JSAbortControllerPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsAbortControllerConstructor, 0 } },
    HashTableValue { "signal"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsAbortController_signal, 0 } },
    HashTableValue { "abort"_s, static_cast<unsigned>(JSC::PropertyAttribute::Function), NoIntrinsic, { HashTableValue::NativeFunctionType, jsAbortControllerPrototypeFunction_abort, 0 } },
};
...
static inline JSC::EncodedJSValue jsAbortControllerPrototypeFunction_abortBody(JSC::JSGlobalObject* lexicalGlobalObject, JSC::CallFrame* callFrame, typename IDLOperation<JSAbortController>::ClassParameter castedThis)
{
    ...
    RELEASE_AND_RETURN(throwScope, JSValue::encode(toJS<IDLUndefined>(*lexicalGlobalObject, throwScope, [&]() -> decltype(auto) { return impl.abort(reasonConversionResult.releaseReturnValue()); })));
}
...
{
    return WebCore::subspaceForImpl<JSAbortController, UseCustomHeapCellType::No>(vm, "JSAbortController"_s,
...
void JSAbortControllerOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsAbortController->protectedWrapped().ptr(), jsAbortController);
}
...
extern "C" { extern void (*const __identifier("??_7AbortController@WebCore@@6B@")[])(); }
#else
extern "C" { extern void* _ZTVN7WebCore15AbortControllerE[]; }
#endif
template<std::same_as<AbortController> T>
static inline void verifyVTable(AbortController* ptr) 
{
...
{
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<AbortController>(impl.ptr());
#endif
