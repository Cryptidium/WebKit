...
public:
    ...
    static JSSVGPointList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPointList>&& impl)
    {
        ...
        JSSVGPointList* ptr = new (NotNull, JSC::allocateCell<JSSVGPointList>(vm)) JSSVGPointList(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, SVGPointList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
