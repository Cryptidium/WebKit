...
public:
    ...
    static JSDOMStringMap* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<DOMStringMap>&& impl)
    {
        ...
        JSDOMStringMap* ptr = new (NotNull, JSC::allocateCell<JSDOMStringMap>(vm)) JSDOMStringMap(structure, *globalObject, WTFMove(impl));
...
class JSDOMStringMapOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, DOMStringMap& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
