...
static const std::array<HashTableValue, 1> JSWebGLTransformFeedbackPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsWebGLTransformFeedbackConstructor, 0 } },
};
...
JSC_DEFINE_CUSTOM_GETTER(jsWebGLTransformFeedbackConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSWebGLTransformFeedback::getConstructor(vm, prototype->globalObject()));
}

JSC::GCClient::IsoSubspace* JSWebGLTransformFeedback::subspaceForImpl(JSC::VM& vm)
{
    return WebCore::subspaceForImpl<JSWebGLTransformFeedback, UseCustomHeapCellType::No>(vm, "JSWebGLTransformFeedback"_s,
...
bool JSWebGLTransformFeedbackOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, ASCIILiteral* reason)
{
    ...
    if (reason) [[unlikely]]
        *reason = "Reachable from WebGLTransformFeedback"_s;
...
void JSWebGLTransformFeedbackOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsWebGLTransformFeedback->protectedWrapped().ptr(), jsWebGLTransformFeedback);
}
...
#endif
template<std::same_as<WebGLTransformFeedback> T>
static inline void verifyVTable(WebGLTransformFeedback* ptr) 
{
...
{
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<WebGLTransformFeedback>(impl.ptr());
#endif
