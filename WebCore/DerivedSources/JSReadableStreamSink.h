...
public:
    ...
    static JSReadableStreamSink* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<ReadableStreamSink>&& impl)
    {
        ...
        JSReadableStreamSink* ptr = new (NotNull, JSC::allocateCell<JSReadableStreamSink>(vm)) JSReadableStreamSink(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, ReadableStreamSink& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
