...
class WEBCORE_EXPORT JSHTMLAttachmentElement : public JSHTMLElement {
public:
    ...
    static JSHTMLAttachmentElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLAttachmentElement>&& impl)
    {
        ...
        JSHTMLAttachmentElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLAttachmentElement>(vm)) JSHTMLAttachmentElement(structure, *globalObject, WTFMove(impl));
    ...
    static HTMLAttachmentElement* toWrapped(JSC::VM&, JSC::JSValue);
    ...
    Ref<HTMLAttachmentElement> protectedWrapped() const;
