...
static const std::array<HashTableValue, 10> JSWebGLCompressedTextureETCPrototypeTableValues {
    HashTableValue { "COMPRESSED_R11_EAC"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9270 } },
    HashTableValue { "COMPRESSED_SIGNED_R11_EAC"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9271 } },
    HashTableValue { "COMPRESSED_RG11_EAC"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9272 } },
    HashTableValue { "COMPRESSED_SIGNED_RG11_EAC"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9273 } },
    HashTableValue { "COMPRESSED_RGB8_ETC2"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9274 } },
    HashTableValue { "COMPRESSED_SRGB8_ETC2"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9275 } },
    HashTableValue { "COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9276 } },
    HashTableValue { "COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9277 } },
    HashTableValue { "COMPRESSED_RGBA8_ETC2_EAC"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9278 } },
    HashTableValue { "COMPRESSED_SRGB8_ALPHA8_ETC2_EAC"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9279 } },
};
...
{
    return WebCore::subspaceForImpl<JSWebGLCompressedTextureETC, UseCustomHeapCellType::No>(vm, "JSWebGLCompressedTextureETC"_s,
...
#endif
template<std::same_as<WebGLCompressedTextureETC> T>
static inline void verifyVTable(WebGLCompressedTextureETC* ptr) 
{
