...
public:
    ...
    static JSSVGTSpanElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGTSpanElement>&& impl)
    {
        ...
        JSSVGTSpanElement* ptr = new (NotNull, JSC::allocateCell<JSSVGTSpanElement>(vm)) JSSVGTSpanElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGTSpanElement> protectedWrapped() const;
