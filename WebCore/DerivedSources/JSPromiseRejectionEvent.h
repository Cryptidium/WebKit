...
public:
    ...
    static JSPromiseRejectionEvent* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<PromiseRejectionEvent>&& impl)
    {
        ...
        JSPromiseRejectionEvent* ptr = new (NotNull, JSC::allocateCell<JSPromiseRejectionEvent>(vm)) JSPromiseRejectionEvent(structure, *globalObject, WTFMove(impl));
    ...
    Ref<PromiseRejectionEvent> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, PromiseRejectionEvent& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> ConversionResult<IDLDictionary<PromiseRejectionEvent::Init>> convertDictionary<PromiseRejectionEvent::Init>(JSC::JSGlobalObject&, JSC::JSValue);
