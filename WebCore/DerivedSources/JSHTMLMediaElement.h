...
public:
    ...
    static JSHTMLMediaElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLMediaElement>&& impl)
    {
        ...
        JSHTMLMediaElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLMediaElement>(vm)) JSHTMLMediaElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLMediaElement> protectedWrapped() const;
...
class WEBCORE_EXPORT JSHTMLMediaElementOwner final : public JSNodeOwner {
public:
