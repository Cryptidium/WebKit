...
public:
    ...
    static JSHTMLMenuElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLMenuElement>&& impl)
    {
        ...
        JSHTMLMenuElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLMenuElement>(vm)) JSHTMLMenuElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLMenuElement> protectedWrapped() const;
