...
static const std::array<HashTableValue, 7> JSSVGRadialGradientElementPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGRadialGradientElementConstructor, 0 } },
    HashTableValue { "cx"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGRadialGradientElement_cx, 0 } },
    HashTableValue { "cy"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGRadialGradientElement_cy, 0 } },
    HashTableValue { "r"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGRadialGradientElement_r, 0 } },
    HashTableValue { "fx"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGRadialGradientElement_fx, 0 } },
    HashTableValue { "fy"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGRadialGradientElement_fy, 0 } },
    HashTableValue { "fr"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGRadialGradientElement_fr, 0 } },
};
...
Ref<SVGRadialGradientElement> JSSVGRadialGradientElement::protectedWrapped() const
{
    return wrapped();
}
...
JSC_DEFINE_CUSTOM_GETTER(jsSVGRadialGradientElementConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSSVGRadialGradientElement::getConstructor(vm, prototype->globalObject()));
}
...
{
    return WebCore::subspaceForImpl<JSSVGRadialGradientElement, UseCustomHeapCellType::No>(vm, "JSSVGRadialGradientElement"_s,
