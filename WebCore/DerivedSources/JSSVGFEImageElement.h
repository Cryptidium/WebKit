...
public:
    ...
    static JSSVGFEImageElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEImageElement>&& impl)
    {
        ...
        JSSVGFEImageElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEImageElement>(vm)) JSSVGFEImageElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEImageElement> protectedWrapped() const;
