...
public:
    ...
    static JSMessageChannel* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<MessageChannel>&& impl)
    {
        ...
        JSMessageChannel* ptr = new (NotNull, JSC::allocateCell<JSMessageChannel>(vm)) JSMessageChannel(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, MessageChannel& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
