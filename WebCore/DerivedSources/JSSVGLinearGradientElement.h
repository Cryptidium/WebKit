...
public:
    ...
    static JSSVGLinearGradientElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGLinearGradientElement>&& impl)
    {
        ...
        JSSVGLinearGradientElement* ptr = new (NotNull, JSC::allocateCell<JSSVGLinearGradientElement>(vm)) JSSVGLinearGradientElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGLinearGradientElement> protectedWrapped() const;
