...
public:
    ...
    static JSSVGSwitchElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGSwitchElement>&& impl)
    {
        ...
        JSSVGSwitchElement* ptr = new (NotNull, JSC::allocateCell<JSSVGSwitchElement>(vm)) JSSVGSwitchElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGSwitchElement> protectedWrapped() const;
