...
{
    return WebCore::subspaceForImpl<JSWebGLRenderSharedExponent, UseCustomHeapCellType::No>(vm, "JSWebGLRenderSharedExponent"_s,
...
#endif
template<std::same_as<WebGLRenderSharedExponent> T>
static inline void verifyVTable(WebGLRenderSharedExponent* ptr) 
{
