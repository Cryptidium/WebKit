...
public:
    ...
    static JSWorkerNavigator* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<WorkerNavigator>&& impl)
    {
        ...
        JSWorkerNavigator* ptr = new (NotNull, JSC::allocateCell<JSWorkerNavigator>(vm)) JSWorkerNavigator(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, WorkerNavigator& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
