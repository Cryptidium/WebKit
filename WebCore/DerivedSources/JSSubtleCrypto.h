...
public:
    ...
    static JSSubtleCrypto* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SubtleCrypto>&& impl)
    {
        ...
        JSSubtleCrypto* ptr = new (NotNull, JSC::allocateCell<JSSubtleCrypto>(vm)) JSSubtleCrypto(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, SubtleCrypto& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> JSC::JSString* convertEnumerationToJS(JSC::VM&, SubtleCrypto::KeyFormat);

template<> std::optional<SubtleCrypto::KeyFormat> parseEnumerationFromString<SubtleCrypto::KeyFormat>(const String&);
