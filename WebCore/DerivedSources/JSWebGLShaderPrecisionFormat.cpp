...
static const std::array<HashTableValue, 4> JSWebGLShaderPrecisionFormatPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsWebGLShaderPrecisionFormatConstructor, 0 } },
    HashTableValue { "rangeMin"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsWebGLShaderPrecisionFormat_rangeMin, 0 } },
    HashTableValue { "rangeMax"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsWebGLShaderPrecisionFormat_rangeMax, 0 } },
    HashTableValue { "precision"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsWebGLShaderPrecisionFormat_precision, 0 } },
};
...
{
    return WebCore::subspaceForImpl<JSWebGLShaderPrecisionFormat, UseCustomHeapCellType::No>(vm, "JSWebGLShaderPrecisionFormat"_s,
...
#endif
template<std::same_as<WebGLShaderPrecisionFormat> T>
static inline void verifyVTable(WebGLShaderPrecisionFormat* ptr) 
{
