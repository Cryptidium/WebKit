...
public:
    ...
    static JSHTMLLIElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLLIElement>&& impl)
    {
        ...
        JSHTMLLIElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLLIElement>(vm)) JSHTMLLIElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLLIElement> protectedWrapped() const;
