...
public:
    ...
    static JSDOMURL* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<DOMURL>&& impl)
    {
        ...
        JSDOMURL* ptr = new (NotNull, JSC::allocateCell<JSDOMURL>(vm)) JSDOMURL(structure, *globalObject, WTFMove(impl));
...
class WEBCORE_EXPORT JSDOMURLOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, DOMURL& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
