...
public:
    ...
    static JSSVGMPathElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGMPathElement>&& impl)
    {
        ...
        JSSVGMPathElement* ptr = new (NotNull, JSC::allocateCell<JSSVGMPathElement>(vm)) JSSVGMPathElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGMPathElement> protectedWrapped() const;
