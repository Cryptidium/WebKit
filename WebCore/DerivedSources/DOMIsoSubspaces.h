...
public:
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForFileSystemWritableFileStream;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForDigitalCredential;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForMediaSourceHandle;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForIntegrityPolicyViolationReportBody;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForXRCompositionLayer;
    std::unique_ptr<IsoSubspace> m_subspaceForXRCubeLayer;
    std::unique_ptr<IsoSubspace> m_subspaceForXRCylinderLayer;
    std::unique_ptr<IsoSubspace> m_subspaceForXREquirectLayer;
    std::unique_ptr<IsoSubspace> m_subspaceForXRGPUBinding;
    std::unique_ptr<IsoSubspace> m_subspaceForXRGPUSubImage;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForXRLayerEvent;
    std::unique_ptr<IsoSubspace> m_subspaceForXRProjectionLayer;
    std::unique_ptr<IsoSubspace> m_subspaceForXRQuadLayer;
    std::unique_ptr<IsoSubspace> m_subspaceForXRReferenceSpaceEvent;
    std::unique_ptr<IsoSubspace> m_subspaceForXRSessionEvent;
    std::unique_ptr<IsoSubspace> m_subspaceForXRSubImage;
    std::unique_ptr<IsoSubspace> m_subspaceForXRWebGLBinding;
    std::unique_ptr<IsoSubspace> m_subspaceForXRWebGLSubImage;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForCSSFontFaceDescriptors;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForCSSNestedDeclarations;
    std::unique_ptr<IsoSubspace> m_subspaceForCSSPageDescriptors;
    std::unique_ptr<IsoSubspace> m_subspaceForCSSPageRule;
    std::unique_ptr<IsoSubspace> m_subspaceForCSSPaintSize;
    std::unique_ptr<IsoSubspace> m_subspaceForCSSPositionTryDescriptors;
    std::unique_ptr<IsoSubspace> m_subspaceForCSSPositionTryRule;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForCSSStyleProperties;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForCSSViewTransitionRule;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForCSSOMColor;
    std::unique_ptr<IsoSubspace> m_subspaceForCSSOMColorValue;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForObservable;
    std::unique_ptr<IsoSubspace> m_subspaceForOverflowEvent;
    std::unique_ptr<IsoSubspace> m_subspaceForPageRevealEvent;
    std::unique_ptr<IsoSubspace> m_subspaceForPageSwapEvent;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForSubscriber;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForViewTransitionTypeSet;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForCloseWatcher;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForEventCounts;
    std::unique_ptr<IsoSubspace> m_subspaceForEventSource;
    std::unique_ptr<IsoSubspace> m_subspaceForFragmentDirective;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForNavigationActivation;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForNavigatorUAData;
    std::unique_ptr<IsoSubspace> m_subspaceForPerformance;
    std::unique_ptr<IsoSubspace> m_subspaceForPerformanceEntry;
    std::unique_ptr<IsoSubspace> m_subspaceForPerformanceEventTiming;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForWebKitNodeInfo;
    std::unique_ptr<IsoSubspace> m_subspaceForWebKitPoint;
    std::unique_ptr<IsoSubspace> m_subspaceForWebKitSerializedNode;
    ...
    std::unique_ptr<IsoSubspace> m_subspaceForInstallEvent;
