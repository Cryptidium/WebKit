...
public:
    ...
    static JSVTTRegionList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<VTTRegionList>&& impl)
    {
        ...
        JSVTTRegionList* ptr = new (NotNull, JSC::allocateCell<JSVTTRegionList>(vm)) JSVTTRegionList(structure, *globalObject, WTFMove(impl));
...
class JSVTTRegionListOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, VTTRegionList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
