...
public:
    ...
    static JSHTMLTableSectionElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLTableSectionElement>&& impl)
    {
        ...
        JSHTMLTableSectionElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLTableSectionElement>(vm)) JSHTMLTableSectionElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLTableSectionElement> protectedWrapped() const;
