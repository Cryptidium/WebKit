...
public:
    ...
    static JSHTMLMapElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLMapElement>&& impl)
    {
        ...
        JSHTMLMapElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLMapElement>(vm)) JSHTMLMapElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLMapElement> protectedWrapped() const;
