...
public:
    ...
    static JSPerformanceMeasure* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<PerformanceMeasure>&& impl)
    {
        ...
        JSPerformanceMeasure* ptr = new (NotNull, JSC::allocateCell<JSPerformanceMeasure>(vm)) JSPerformanceMeasure(structure, *globalObject, WTFMove(impl));
    ...
    Ref<PerformanceMeasure> protectedWrapped() const;
