...
public:
    ...
    static JSHTMLSpanElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLSpanElement>&& impl)
    {
        ...
        JSHTMLSpanElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLSpanElement>(vm)) JSHTMLSpanElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLSpanElement> protectedWrapped() const;
