...
template<> ConversionResult<IDLDictionary<CryptoAlgorithmRsaHashedKeyGenParams>> convertDictionary<CryptoAlgorithmRsaHashedKeyGenParams>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
