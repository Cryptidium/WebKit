...
static const std::array<HashTableValue, 2> JSGPUExternalTexturePrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsGPUExternalTextureConstructor, 0 } },
    HashTableValue { "label"_s, JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsGPUExternalTexture_label, setJSGPUExternalTexture_label } },
};
...
{
    return WebCore::subspaceForImpl<JSGPUExternalTexture, UseCustomHeapCellType::No>(vm, "JSGPUExternalTexture"_s,
...
#endif
template<std::same_as<GPUExternalTexture> T>
static inline void verifyVTable(GPUExternalTexture* ptr) 
{
