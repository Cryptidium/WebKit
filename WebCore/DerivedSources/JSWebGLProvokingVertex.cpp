...
static const std::array<HashTableValue, 4> JSWebGLProvokingVertexPrototypeTableValues {
    HashTableValue { "provokingVertexWEBGL"_s, static_cast<unsigned>(JSC::PropertyAttribute::Function), NoIntrinsic, { HashTableValue::NativeFunctionType, jsWebGLProvokingVertexPrototypeFunction_provokingVertexWEBGL, 1 } },
    HashTableValue { "FIRST_VERTEX_CONVENTION_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8E4D } },
    HashTableValue { "LAST_VERTEX_CONVENTION_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8E4E } },
    HashTableValue { "PROVOKING_VERTEX_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8E4F } },
};
...
static inline JSC::EncodedJSValue jsWebGLProvokingVertexPrototypeFunction_provokingVertexWEBGLBody(JSC::JSGlobalObject* lexicalGlobalObject, JSC::CallFrame* callFrame, typename IDLOperation<JSWebGLProvokingVertex>::ClassParameter castedThis)
{
    ...
    if (provokeModeConversionResult.hasException(throwScope)) [[unlikely]]
...
{
    return WebCore::subspaceForImpl<JSWebGLProvokingVertex, UseCustomHeapCellType::No>(vm, "JSWebGLProvokingVertex"_s,
...
#endif
template<std::same_as<WebGLProvokingVertex> T>
static inline void verifyVTable(WebGLProvokingVertex* ptr) 
{
