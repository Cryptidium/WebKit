...
public:
    ...
    static JSHTMLTemplateElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLTemplateElement>&& impl)
    {
        ...
        JSHTMLTemplateElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLTemplateElement>(vm)) JSHTMLTemplateElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLTemplateElement> protectedWrapped() const;
