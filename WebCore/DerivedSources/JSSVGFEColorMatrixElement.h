...
public:
    ...
    static JSSVGFEColorMatrixElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEColorMatrixElement>&& impl)
    {
        ...
        JSSVGFEColorMatrixElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEColorMatrixElement>(vm)) JSSVGFEColorMatrixElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEColorMatrixElement> protectedWrapped() const;
