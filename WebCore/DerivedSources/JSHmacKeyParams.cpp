...
template<> ConversionResult<IDLDictionary<CryptoAlgorithmHmacKeyParams>> convertDictionary<CryptoAlgorithmHmacKeyParams>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (!lengthValue.isUndefined()) {
        auto lengthConversionResult = convert<IDLEnforceRangeAdaptor<IDLUnsignedLong>>(lexicalGlobalObject, lengthValue);
