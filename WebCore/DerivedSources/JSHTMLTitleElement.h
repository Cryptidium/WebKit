...
public:
    ...
    static JSHTMLTitleElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLTitleElement>&& impl)
    {
        ...
        JSHTMLTitleElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLTitleElement>(vm)) JSHTMLTitleElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLTitleElement> protectedWrapped() const;
