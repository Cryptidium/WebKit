...
{
    static constexpr std::array<std::pair<ComparableASCIILiteral, GPUAddressMode>, 3> mappings {
        std::pair<ComparableASCIILiteral, GPUAddressMode> { "clamp-to-edge"_s, GPUAddressMode::ClampToEdge },
        std::pair<ComparableASCIILiteral, GPUAddressMode> { "mirror-repeat"_s, GPUAddressMode::MirrorRepeat },
        std::pair<ComparableASCIILiteral, GPUAddressMode> { "repeat"_s, GPUAddressMode::Repeat },
    };
