...
public:
    ...
    static JSCSSKeyframesRule* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSKeyframesRule>&& impl)
    {
        ...
        JSCSSKeyframesRule* ptr = new (NotNull, JSC::allocateCell<JSCSSKeyframesRule>(vm)) JSCSSKeyframesRule(structure, *globalObject, WTFMove(impl));
    ...
    Ref<CSSKeyframesRule> protectedWrapped() const;
