...
public:
    ...
    static JSSVGPathSegMovetoAbs* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegMovetoAbs>&& impl)
    {
        ...
        JSSVGPathSegMovetoAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegMovetoAbs>(vm)) JSSVGPathSegMovetoAbs(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPathSegMovetoAbs> protectedWrapped() const;
