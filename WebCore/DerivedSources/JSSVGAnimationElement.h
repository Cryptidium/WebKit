...
public:
    ...
    static JSSVGAnimationElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGAnimationElement>&& impl)
    {
        ...
        JSSVGAnimationElement* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimationElement>(vm)) JSSVGAnimationElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGAnimationElement> protectedWrapped() const;
