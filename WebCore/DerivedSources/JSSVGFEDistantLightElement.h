...
public:
    ...
    static JSSVGFEDistantLightElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEDistantLightElement>&& impl)
    {
        ...
        JSSVGFEDistantLightElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEDistantLightElement>(vm)) JSSVGFEDistantLightElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEDistantLightElement> protectedWrapped() const;
