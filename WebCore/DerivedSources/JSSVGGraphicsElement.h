...
public:
    ...
    static JSSVGGraphicsElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGGraphicsElement>&& impl)
    {
        ...
        JSSVGGraphicsElement* ptr = new (NotNull, JSC::allocateCell<JSSVGGraphicsElement>(vm)) JSSVGGraphicsElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGGraphicsElement> protectedWrapped() const;
