...
public:
    ...
    static JSPerformanceObserver* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<PerformanceObserver>&& impl)
    {
        ...
        JSPerformanceObserver* ptr = new (NotNull, JSC::allocateCell<JSPerformanceObserver>(vm)) JSPerformanceObserver(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, PerformanceObserver& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> ConversionResult<IDLDictionary<PerformanceObserver::Init>> convertDictionary<PerformanceObserver::Init>(JSC::JSGlobalObject&, JSC::JSValue);
