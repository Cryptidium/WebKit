...
public:
    ...
    static JSClipboard* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<Clipboard>&& impl)
    {
        ...
        JSClipboard* ptr = new (NotNull, JSC::allocateCell<JSClipboard>(vm)) JSClipboard(structure, *globalObject, WTFMove(impl));
    ...
    Ref<Clipboard> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, Clipboard& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
