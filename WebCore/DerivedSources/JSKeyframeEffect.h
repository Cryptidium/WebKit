...
public:
    ...
    static JSKeyframeEffect* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<KeyframeEffect>&& impl)
    {
        ...
        JSKeyframeEffect* ptr = new (NotNull, JSC::allocateCell<JSKeyframeEffect>(vm)) JSKeyframeEffect(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, KeyframeEffect& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> ConversionResult<IDLDictionary<KeyframeEffect::BasePropertyIndexedKeyframe>> convertDictionary<KeyframeEffect::BasePropertyIndexedKeyframe>(JSC::JSGlobalObject&, JSC::JSValue);

template<> ConversionResult<IDLDictionary<KeyframeEffect::BaseKeyframe>> convertDictionary<KeyframeEffect::BaseKeyframe>(JSC::JSGlobalObject&, JSC::JSValue);
