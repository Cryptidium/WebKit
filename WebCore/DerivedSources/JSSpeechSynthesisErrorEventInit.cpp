...
template<> ConversionResult<IDLDictionary<SpeechSynthesisErrorEventInit>> convertDictionary<SpeechSynthesisErrorEventInit>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    SpeechSynthesisErrorEventInit result;
    ...
    if (utteranceValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "utterance"_s, "SpeechSynthesisErrorEventInit"_s, "SpeechSynthesisUtterance"_s);
        return ConversionResultException { };
    }
    ...
    if (errorValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "error"_s, "SpeechSynthesisErrorEventInit"_s, "SpeechSynthesisErrorCode"_s);
        return ConversionResultException { };
    }
    auto errorConversionResult = convert<IDLEnumeration<SpeechSynthesisErrorCode>>(lexicalGlobalObject, errorValue);
