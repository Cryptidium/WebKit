...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSPerformanceObserverCallback::invoke(typename IDLInterface<PerformanceObserver>::ParameterType thisObject, typename IDLInterface<PerformanceObserverEntryList>::ParameterType entries, typename IDLInterface<PerformanceObserver>::ParameterType observer)
{
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSPerformanceObserverCallback::invokeRethrowingException(typename IDLInterface<PerformanceObserver>::ParameterType thisObject, typename IDLInterface<PerformanceObserverEntryList>::ParameterType entries, typename IDLInterface<PerformanceObserver>::ParameterType observer)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
