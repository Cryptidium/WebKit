...
template<> ConversionResult<IDLDictionary<CryptoAlgorithmEcdsaParams>> convertDictionary<CryptoAlgorithmEcdsaParams>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
