...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSErrorCallback::invoke(typename IDLInterface<DOMException>::ParameterType error)
{
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSErrorCallback::invokeRethrowingException(typename IDLInterface<DOMException>::ParameterType error)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
