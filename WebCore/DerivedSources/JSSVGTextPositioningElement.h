...
public:
    ...
    static JSSVGTextPositioningElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGTextPositioningElement>&& impl)
    {
        ...
        JSSVGTextPositioningElement* ptr = new (NotNull, JSC::allocateCell<JSSVGTextPositioningElement>(vm)) JSSVGTextPositioningElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGTextPositioningElement> protectedWrapped() const;
