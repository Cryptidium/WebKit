...
public:
    ...
    static JSTextEncoder* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<TextEncoder>&& impl)
    {
        ...
        JSTextEncoder* ptr = new (NotNull, JSC::allocateCell<JSTextEncoder>(vm)) JSTextEncoder(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, TextEncoder& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
