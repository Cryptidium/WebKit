...
public:
    ...
    static JSHTMLHtmlElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLHtmlElement>&& impl)
    {
        ...
        JSHTMLHtmlElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLHtmlElement>(vm)) JSHTMLHtmlElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLHtmlElement> protectedWrapped() const;
