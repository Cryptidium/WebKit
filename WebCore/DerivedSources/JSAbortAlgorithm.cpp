...
JSAbortAlgorithm::JSAbortAlgorithm(JSObject* callback, JSDOMGlobalObject* globalObject)
    : AbortAlgorithm(globalObject->scriptExecutionContext())
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSAbortAlgorithm::invoke(typename IDLAny::ParameterType value)
{
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSAbortAlgorithm::invokeRethrowingException(typename IDLAny::ParameterType value)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
