...
public:
    ...
    static JSSVGFESpotLightElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFESpotLightElement>&& impl)
    {
        ...
        JSSVGFESpotLightElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFESpotLightElement>(vm)) JSSVGFESpotLightElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFESpotLightElement> protectedWrapped() const;
