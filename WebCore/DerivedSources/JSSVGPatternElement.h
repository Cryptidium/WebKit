...
public:
    ...
    static JSSVGPatternElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPatternElement>&& impl)
    {
        ...
        JSSVGPatternElement* ptr = new (NotNull, JSC::allocateCell<JSSVGPatternElement>(vm)) JSSVGPatternElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPatternElement> protectedWrapped() const;
