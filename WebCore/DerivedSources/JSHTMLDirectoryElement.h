...
public:
    ...
    static JSHTMLDirectoryElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLDirectoryElement>&& impl)
    {
        ...
        JSHTMLDirectoryElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLDirectoryElement>(vm)) JSHTMLDirectoryElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLDirectoryElement> protectedWrapped() const;
