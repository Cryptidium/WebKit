...
public:
    ...
    static JSSVGFETurbulenceElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFETurbulenceElement>&& impl)
    {
        ...
        JSSVGFETurbulenceElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFETurbulenceElement>(vm)) JSSVGFETurbulenceElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFETurbulenceElement> protectedWrapped() const;
