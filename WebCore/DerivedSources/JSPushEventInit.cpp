...
template<> ConversionResult<IDLDictionary<PushEventInit>> convertDictionary<PushEventInit>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (!dataValue.isUndefined()) {
        auto dataConversionResult = convert<IDLUnion<IDLArrayBufferView, IDLArrayBuffer, IDLUSVString>>(lexicalGlobalObject, dataValue);
