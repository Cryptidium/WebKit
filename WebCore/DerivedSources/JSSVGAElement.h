...
public:
    ...
    static JSSVGAElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGAElement>&& impl)
    {
        ...
        JSSVGAElement* ptr = new (NotNull, JSC::allocateCell<JSSVGAElement>(vm)) JSSVGAElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGAElement> protectedWrapped() const;
