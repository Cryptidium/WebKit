...
public:
    ...
    static JSSVGFilterElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFilterElement>&& impl)
    {
        ...
        JSSVGFilterElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFilterElement>(vm)) JSSVGFilterElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFilterElement> protectedWrapped() const;
