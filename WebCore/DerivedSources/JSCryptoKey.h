...
public:
    ...
    static JSCryptoKey* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CryptoKey>&& impl)
    {
        ...
        JSCryptoKey* ptr = new (NotNull, JSC::allocateCell<JSCryptoKey>(vm)) JSCryptoKey(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, CryptoKey& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> JSC::JSString* convertEnumerationToJS(JSC::VM&, CryptoKey::Type);

template<> std::optional<CryptoKey::Type> parseEnumerationFromString<CryptoKey::Type>(const String&);
