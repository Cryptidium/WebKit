...
public:
    ...
    static JSSVGStopElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGStopElement>&& impl)
    {
        ...
        JSSVGStopElement* ptr = new (NotNull, JSC::allocateCell<JSSVGStopElement>(vm)) JSSVGStopElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGStopElement> protectedWrapped() const;
