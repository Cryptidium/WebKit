...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSPositionCallback::invoke(typename IDLNullable<IDLInterface<GeolocationPosition>>::ParameterType position)
{
    ...
    args.append(toJS<IDLNullable<IDLInterface<GeolocationPosition>>>(lexicalGlobalObject, globalObject, position));
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSPositionCallback::invokeRethrowingException(typename IDLNullable<IDLInterface<GeolocationPosition>>::ParameterType position)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
