...
public:
    ...
    static JSImageData* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<ImageData>&& impl)
    {
        ...
        JSImageData* ptr = new (NotNull, JSC::allocateCell<JSImageData>(vm)) JSImageData(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, ImageData& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
