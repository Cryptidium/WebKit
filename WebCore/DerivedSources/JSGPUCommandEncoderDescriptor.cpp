...
template<> ConversionResult<IDLDictionary<GPUCommandEncoderDescriptor>> convertDictionary<GPUCommandEncoderDescriptor>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
