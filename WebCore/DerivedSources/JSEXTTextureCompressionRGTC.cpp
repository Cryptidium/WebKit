...
static const std::array<HashTableValue, 4> JSEXTTextureCompressionRGTCPrototypeTableValues {
    HashTableValue { "COMPRESSED_RED_RGTC1_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8DBB } },
    HashTableValue { "COMPRESSED_SIGNED_RED_RGTC1_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8DBC } },
    HashTableValue { "COMPRESSED_RED_GREEN_RGTC2_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8DBD } },
    HashTableValue { "COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8DBE } },
};
...
{
    return WebCore::subspaceForImpl<JSEXTTextureCompressionRGTC, UseCustomHeapCellType::No>(vm, "JSEXTTextureCompressionRGTC"_s,
...
#endif
template<std::same_as<EXTTextureCompressionRGTC> T>
static inline void verifyVTable(EXTTextureCompressionRGTC* ptr) 
{
