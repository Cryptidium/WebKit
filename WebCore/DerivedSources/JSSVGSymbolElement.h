...
public:
    ...
    static JSSVGSymbolElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGSymbolElement>&& impl)
    {
        ...
        JSSVGSymbolElement* ptr = new (NotNull, JSC::allocateCell<JSSVGSymbolElement>(vm)) JSSVGSymbolElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGSymbolElement> protectedWrapped() const;
