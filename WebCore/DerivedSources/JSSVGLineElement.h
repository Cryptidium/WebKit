...
public:
    ...
    static JSSVGLineElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGLineElement>&& impl)
    {
        ...
        JSSVGLineElement* ptr = new (NotNull, JSC::allocateCell<JSSVGLineElement>(vm)) JSSVGLineElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGLineElement> protectedWrapped() const;
