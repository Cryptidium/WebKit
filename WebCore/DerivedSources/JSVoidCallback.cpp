...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSVoidCallback::invoke()
{
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSVoidCallback::invokeRethrowingException()
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
