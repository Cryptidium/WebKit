...
public:
    ...
    static JSSVGFEMergeNodeElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEMergeNodeElement>&& impl)
    {
        ...
        JSSVGFEMergeNodeElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEMergeNodeElement>(vm)) JSSVGFEMergeNodeElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEMergeNodeElement> protectedWrapped() const;
