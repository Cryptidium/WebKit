...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSDatabaseCallback::invoke(typename IDLInterface<Database>::ParameterType database)
{
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSDatabaseCallback::invokeRethrowingException(typename IDLInterface<Database>::ParameterType database)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
