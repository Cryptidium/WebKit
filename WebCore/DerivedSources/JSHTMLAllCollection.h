...
public:
    ...
    static JSHTMLAllCollection* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLAllCollection>&& impl)
    {
        ...
        JSHTMLAllCollection* ptr = new (NotNull, JSC::allocateCell<JSHTMLAllCollection>(vm)) JSHTMLAllCollection(structure, *globalObject, WTFMove(impl));
...
class JSHTMLAllCollectionOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, HTMLAllCollection& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
