...
public:
    ...
    static JSSVGPolylineElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPolylineElement>&& impl)
    {
        ...
        JSSVGPolylineElement* ptr = new (NotNull, JSC::allocateCell<JSSVGPolylineElement>(vm)) JSSVGPolylineElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPolylineElement> protectedWrapped() const;
