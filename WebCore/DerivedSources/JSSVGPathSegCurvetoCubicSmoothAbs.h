...
public:
    ...
    static JSSVGPathSegCurvetoCubicSmoothAbs* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegCurvetoCubicSmoothAbs>&& impl)
    {
        ...
        JSSVGPathSegCurvetoCubicSmoothAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegCurvetoCubicSmoothAbs>(vm)) JSSVGPathSegCurvetoCubicSmoothAbs(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPathSegCurvetoCubicSmoothAbs> protectedWrapped() const;
