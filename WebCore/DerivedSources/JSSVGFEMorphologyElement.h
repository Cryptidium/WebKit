...
public:
    ...
    static JSSVGFEMorphologyElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEMorphologyElement>&& impl)
    {
        ...
        JSSVGFEMorphologyElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEMorphologyElement>(vm)) JSSVGFEMorphologyElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEMorphologyElement> protectedWrapped() const;
