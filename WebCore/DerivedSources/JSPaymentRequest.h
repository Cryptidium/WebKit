...
public:
    ...
    static JSPaymentRequest* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<PaymentRequest>&& impl)
    {
        ...
        JSPaymentRequest* ptr = new (NotNull, JSC::allocateCell<JSPaymentRequest>(vm)) JSPaymentRequest(structure, *globalObject, WTFMove(impl));
    ...
    Ref<PaymentRequest> protectedWrapped() const;
...
class JSPaymentRequestOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, PaymentRequest& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
