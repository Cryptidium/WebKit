...
class JSCSSMediaRule : public JSCSSConditionRule {
public:
    ...
    static JSCSSMediaRule* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSMediaRule>&& impl)
    {
        ...
        JSCSSMediaRule* ptr = new (NotNull, JSC::allocateCell<JSCSSMediaRule>(vm)) JSCSSMediaRule(structure, *globalObject, WTFMove(impl));
    ...
    Ref<CSSMediaRule> protectedWrapped() const;
