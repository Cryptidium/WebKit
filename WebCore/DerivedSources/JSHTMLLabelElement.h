...
public:
    ...
    static JSHTMLLabelElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLLabelElement>&& impl)
    {
        ...
        JSHTMLLabelElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLLabelElement>(vm)) JSHTMLLabelElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLLabelElement> protectedWrapped() const;
