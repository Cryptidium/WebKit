...
public:
    ...
    static JSCSSStyleRule* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSStyleRule>&& impl)
    {
        ...
        JSCSSStyleRule* ptr = new (NotNull, JSC::allocateCell<JSCSSStyleRule>(vm)) JSCSSStyleRule(structure, *globalObject, WTFMove(impl));
    ...
    Ref<CSSStyleRule> protectedWrapped() const;
