...
public:
    ...
    static JSCSSImportRule* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSImportRule>&& impl)
    {
        ...
        JSCSSImportRule* ptr = new (NotNull, JSC::allocateCell<JSCSSImportRule>(vm)) JSCSSImportRule(structure, *globalObject, WTFMove(impl));
    ...
    Ref<CSSImportRule> protectedWrapped() const;
