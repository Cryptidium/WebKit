...
public:
    ...
    static JSHTMLTrackElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLTrackElement>&& impl)
    {
        ...
        JSHTMLTrackElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLTrackElement>(vm)) JSHTMLTrackElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLTrackElement> protectedWrapped() const;
...
class JSHTMLTrackElementOwner final : public JSNodeOwner {
public:
