...
class JSCSSSupportsRule : public JSCSSConditionRule {
public:
    ...
    static JSCSSSupportsRule* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSSupportsRule>&& impl)
    {
        ...
        JSCSSSupportsRule* ptr = new (NotNull, JSC::allocateCell<JSCSSSupportsRule>(vm)) JSCSSSupportsRule(structure, *globalObject, WTFMove(impl));
    ...
    Ref<CSSSupportsRule> protectedWrapped() const;
