...
public:
    ...
    static JSXMLHttpRequestProgressEvent* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<XMLHttpRequestProgressEvent>&& impl)
    {
        ...
        JSXMLHttpRequestProgressEvent* ptr = new (NotNull, JSC::allocateCell<JSXMLHttpRequestProgressEvent>(vm)) JSXMLHttpRequestProgressEvent(structure, *globalObject, WTFMove(impl));
    ...
    Ref<XMLHttpRequestProgressEvent> protectedWrapped() const;
