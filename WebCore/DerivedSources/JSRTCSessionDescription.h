...
public:
    ...
    static JSRTCSessionDescription* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<RTCSessionDescription>&& impl)
    {
        ...
        JSRTCSessionDescription* ptr = new (NotNull, JSC::allocateCell<JSRTCSessionDescription>(vm)) JSRTCSessionDescription(structure, *globalObject, WTFMove(impl));
...
class JSRTCSessionDescriptionOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, RTCSessionDescription& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
