...
public:
    ...
    static JSFetchHeaders* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<FetchHeaders>&& impl)
    {
        ...
        JSFetchHeaders* ptr = new (NotNull, JSC::allocateCell<JSFetchHeaders>(vm)) JSFetchHeaders(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, FetchHeaders& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
