...
public:
    ...
    static JSTouchList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<TouchList>&& impl)
    {
        ...
        JSTouchList* ptr = new (NotNull, JSC::allocateCell<JSTouchList>(vm)) JSTouchList(structure, *globalObject, WTFMove(impl));
...
class JSTouchListOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, TouchList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
