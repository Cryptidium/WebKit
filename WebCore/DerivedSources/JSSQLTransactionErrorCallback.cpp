...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSSQLTransactionErrorCallback::invoke(typename IDLInterface<SQLError>::ParameterType error)
{
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSSQLTransactionErrorCallback::invokeRethrowingException(typename IDLInterface<SQLError>::ParameterType error)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
