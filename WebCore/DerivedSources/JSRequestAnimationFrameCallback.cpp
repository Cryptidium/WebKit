...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSRequestAnimationFrameCallback::invoke(typename IDLDouble::ParameterType highResTime)
{
    ...
    args.append(toJS<IDLDouble>(highResTime));
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSRequestAnimationFrameCallback::invokeRethrowingException(typename IDLDouble::ParameterType highResTime)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
