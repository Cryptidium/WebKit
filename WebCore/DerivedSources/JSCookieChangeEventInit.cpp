...
template<> ConversionResult<IDLDictionary<CookieChangeEventInit>> convertDictionary<CookieChangeEventInit>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
