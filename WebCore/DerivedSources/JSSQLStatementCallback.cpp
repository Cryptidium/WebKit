...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSSQLStatementCallback::invoke(typename IDLInterface<SQLTransaction>::ParameterType transaction, typename IDLInterface<SQLResultSet>::ParameterType resultSet)
{
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSSQLStatementCallback::invokeRethrowingException(typename IDLInterface<SQLTransaction>::ParameterType transaction, typename IDLInterface<SQLResultSet>::ParameterType resultSet)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
