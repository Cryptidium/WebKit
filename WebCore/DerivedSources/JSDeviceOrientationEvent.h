...
public:
    ...
    static JSDeviceOrientationEvent* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<DeviceOrientationEvent>&& impl)
    {
        ...
        JSDeviceOrientationEvent* ptr = new (NotNull, JSC::allocateCell<JSDeviceOrientationEvent>(vm)) JSDeviceOrientationEvent(structure, *globalObject, WTFMove(impl));
    ...
    Ref<DeviceOrientationEvent> protectedWrapped() const;
