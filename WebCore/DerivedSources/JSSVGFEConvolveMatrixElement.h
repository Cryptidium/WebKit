...
public:
    ...
    static JSSVGFEConvolveMatrixElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEConvolveMatrixElement>&& impl)
    {
        ...
        JSSVGFEConvolveMatrixElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEConvolveMatrixElement>(vm)) JSSVGFEConvolveMatrixElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEConvolveMatrixElement> protectedWrapped() const;
