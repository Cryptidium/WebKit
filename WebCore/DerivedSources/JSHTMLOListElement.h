...
public:
    ...
    static JSHTMLOListElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLOListElement>&& impl)
    {
        ...
        JSHTMLOListElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLOListElement>(vm)) JSHTMLOListElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLOListElement> protectedWrapped() const;
