...
public:
    ...
    static JSHTMLUListElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLUListElement>&& impl)
    {
        ...
        JSHTMLUListElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLUListElement>(vm)) JSHTMLUListElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLUListElement> protectedWrapped() const;
