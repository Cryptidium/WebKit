...
public:
    ...
    static JSHTMLParamElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLParamElement>&& impl)
    {
        ...
        JSHTMLParamElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLParamElement>(vm)) JSHTMLParamElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLParamElement> protectedWrapped() const;
