...
public:
    ...
    static JSHTMLFrameSetElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLFrameSetElement>&& impl)
    {
        ...
        JSHTMLFrameSetElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLFrameSetElement>(vm)) JSHTMLFrameSetElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLFrameSetElement> protectedWrapped() const;
