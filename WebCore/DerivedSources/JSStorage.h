...
public:
    ...
    static JSStorage* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<Storage>&& impl)
    {
        ...
        JSStorage* ptr = new (NotNull, JSC::allocateCell<JSStorage>(vm)) JSStorage(structure, *globalObject, WTFMove(impl));
...
class JSStorageOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, Storage& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
