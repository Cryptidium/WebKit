...
public:
    ...
    static JSFileSystemFileHandle* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<FileSystemFileHandle>&& impl)
    {
        ...
        JSFileSystemFileHandle* ptr = new (NotNull, JSC::allocateCell<JSFileSystemFileHandle>(vm)) JSFileSystemFileHandle(structure, *globalObject, WTFMove(impl));
...
template<> ConversionResult<IDLDictionary<FileSystemFileHandle::CreateWritableOptions>> convertDictionary<FileSystemFileHandle::CreateWritableOptions>(JSC::JSGlobalObject&, JSC::JSValue);
