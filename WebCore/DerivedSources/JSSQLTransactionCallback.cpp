...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSSQLTransactionCallback::invoke(typename IDLInterface<SQLTransaction>::ParameterType transaction)
{
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSSQLTransactionCallback::invokeRethrowingException(typename IDLInterface<SQLTransaction>::ParameterType transaction)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
