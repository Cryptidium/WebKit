...
public:
    ...
    static JSSVGFEPointLightElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEPointLightElement>&& impl)
    {
        ...
        JSSVGFEPointLightElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEPointLightElement>(vm)) JSSVGFEPointLightElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEPointLightElement> protectedWrapped() const;
