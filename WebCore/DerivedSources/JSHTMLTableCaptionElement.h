...
public:
    ...
    static JSHTMLTableCaptionElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLTableCaptionElement>&& impl)
    {
        ...
        JSHTMLTableCaptionElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLTableCaptionElement>(vm)) JSHTMLTableCaptionElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLTableCaptionElement> protectedWrapped() const;
