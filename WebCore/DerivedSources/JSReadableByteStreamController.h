...
public:
    ...
    static JSReadableByteStreamController* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject)
    {
        ...
        JSReadableByteStreamController* ptr = new (NotNull, JSC::allocateCell<JSReadableByteStreamController>(vm)) JSReadableByteStreamController(structure, *globalObject);
