...
template<> ConversionResult<IDLDictionary<MediaEncodingConfiguration>> convertDictionary<MediaEncodingConfiguration>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (typeValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "type"_s, "MediaEncodingConfiguration"_s, "MediaEncodingType"_s);
        return ConversionResultException { };
    }
    auto typeConversionResult = convert<IDLEnumeration<MediaEncodingType>>(lexicalGlobalObject, typeValue);
...
JSC::JSObject* convertDictionaryToJS(JSC::JSGlobalObject& lexicalGlobalObject, JSDOMGlobalObject& globalObject, const MediaEncodingConfiguration& dictionary)
{
    ...
    auto typeValue = toJS<IDLEnumeration<MediaEncodingType>>(lexicalGlobalObject, throwScope, dictionary.type);
    RETURN_IF_EXCEPTION(throwScope, { });
