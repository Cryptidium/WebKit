...
template<> ConversionResult<IDLDictionary<XRGPULayerInit>> convertDictionary<XRGPULayerInit>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (colorFormatValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "colorFormat"_s, "XRGPULayerInit"_s, "GPUTextureFormat"_s);
        return ConversionResultException { };
    }
    ...
    if (spaceValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "space"_s, "XRGPULayerInit"_s, "WebXRSpace"_s);
        return ConversionResultException { };
    }
    ...
    if (viewPixelHeightValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "viewPixelHeight"_s, "XRGPULayerInit"_s, "unsigned long"_s);
        return ConversionResultException { };
    }
    ...
    if (viewPixelWidthValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "viewPixelWidth"_s, "XRGPULayerInit"_s, "unsigned long"_s);
        return ConversionResultException { };
    }
