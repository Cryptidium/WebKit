...
public:
    ...
    static JSPannerNode* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<PannerNode>&& impl)
    {
        ...
        JSPannerNode* ptr = new (NotNull, JSC::allocateCell<JSPannerNode>(vm)) JSPannerNode(structure, *globalObject, WTFMove(impl));
    ...
    Ref<PannerNode> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, PannerNode& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
