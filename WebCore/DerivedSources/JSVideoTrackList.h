...
public:
    ...
    static JSVideoTrackList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<VideoTrackList>&& impl)
    {
        ...
        JSVideoTrackList* ptr = new (NotNull, JSC::allocateCell<JSVideoTrackList>(vm)) JSVideoTrackList(structure, *globalObject, WTFMove(impl));
    ...
    Ref<VideoTrackList> protectedWrapped() const;
...
class JSVideoTrackListOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, VideoTrackList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
