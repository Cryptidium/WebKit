...
public:
    ...
    static JSCloseEvent* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CloseEvent>&& impl)
    {
        ...
        JSCloseEvent* ptr = new (NotNull, JSC::allocateCell<JSCloseEvent>(vm)) JSCloseEvent(structure, *globalObject, WTFMove(impl));
    ...
    Ref<CloseEvent> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, CloseEvent& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> ConversionResult<IDLDictionary<CloseEvent::Init>> convertDictionary<CloseEvent::Init>(JSC::JSGlobalObject&, JSC::JSValue);
