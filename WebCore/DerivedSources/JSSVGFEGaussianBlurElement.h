...
public:
    ...
    static JSSVGFEGaussianBlurElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEGaussianBlurElement>&& impl)
    {
        ...
        JSSVGFEGaussianBlurElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEGaussianBlurElement>(vm)) JSSVGFEGaussianBlurElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEGaussianBlurElement> protectedWrapped() const;
