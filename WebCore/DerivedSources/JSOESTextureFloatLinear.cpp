...
{
    return WebCore::subspaceForImpl<JSOESTextureFloatLinear, UseCustomHeapCellType::No>(vm, "JSOESTextureFloatLinear"_s,
...
bool JSOESTextureFloatLinearOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, ASCIILiteral* reason)
{
    auto* jsOESTextureFloatLinear = jsCast<JSOESTextureFloatLinear*>(handle.slot()->asCell());
    auto& owner = jsOESTextureFloatLinear->wrapped();
    if (reason) [[unlikely]]
        *reason = "Reachable from jsOESTextureFloatLinear"_s;
...
void JSOESTextureFloatLinearOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsOESTextureFloatLinear->protectedWrapped().ptr(), jsOESTextureFloatLinear);
}
...
#endif
template<std::same_as<OESTextureFloatLinear> T>
static inline void verifyVTable(OESTextureFloatLinear* ptr) 
{
...
{
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<OESTextureFloatLinear>(impl.ptr());
#endif
