...
{
    static constexpr std::array<std::pair<ComparableASCIILiteral, GPUTextureViewDimension>, 6> mappings {
        std::pair<ComparableASCIILiteral, GPUTextureViewDimension> { "1d"_s, GPUTextureViewDimension::_1d },
        std::pair<ComparableASCIILiteral, GPUTextureViewDimension> { "2d"_s, GPUTextureViewDimension::_2d },
        std::pair<ComparableASCIILiteral, GPUTextureViewDimension> { "2d-array"_s, GPUTextureViewDimension::_2dArray },
        std::pair<ComparableASCIILiteral, GPUTextureViewDimension> { "3d"_s, GPUTextureViewDimension::_3d },
        std::pair<ComparableASCIILiteral, GPUTextureViewDimension> { "cube"_s, GPUTextureViewDimension::Cube },
        std::pair<ComparableASCIILiteral, GPUTextureViewDimension> { "cube-array"_s, GPUTextureViewDimension::CubeArray },
    };
