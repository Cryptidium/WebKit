...
public:
    ...
    static JSHTMLEmbedElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLEmbedElement>&& impl)
    {
        ...
        JSHTMLEmbedElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLEmbedElement>(vm)) JSHTMLEmbedElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLEmbedElement> protectedWrapped() const;
