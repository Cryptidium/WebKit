...
public:
    ...
    static JSSVGPolygonElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPolygonElement>&& impl)
    {
        ...
        JSSVGPolygonElement* ptr = new (NotNull, JSC::allocateCell<JSSVGPolygonElement>(vm)) JSSVGPolygonElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPolygonElement> protectedWrapped() const;
