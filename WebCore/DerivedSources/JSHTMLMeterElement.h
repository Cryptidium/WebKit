...
public:
    ...
    static JSHTMLMeterElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLMeterElement>&& impl)
    {
        ...
        JSHTMLMeterElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLMeterElement>(vm)) JSHTMLMeterElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLMeterElement> protectedWrapped() const;
