...
public:
    ...
    static JSClipboardEvent* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<ClipboardEvent>&& impl)
    {
        ...
        JSClipboardEvent* ptr = new (NotNull, JSC::allocateCell<JSClipboardEvent>(vm)) JSClipboardEvent(structure, *globalObject, WTFMove(impl));
    ...
    Ref<ClipboardEvent> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, ClipboardEvent& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> ConversionResult<IDLDictionary<ClipboardEvent::Init>> convertDictionary<ClipboardEvent::Init>(JSC::JSGlobalObject&, JSC::JSValue);
