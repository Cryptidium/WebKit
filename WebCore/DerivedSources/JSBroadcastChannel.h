...
public:
    ...
    static JSBroadcastChannel* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<BroadcastChannel>&& impl)
    {
        ...
        JSBroadcastChannel* ptr = new (NotNull, JSC::allocateCell<JSBroadcastChannel>(vm)) JSBroadcastChannel(structure, *globalObject, WTFMove(impl));
    ...
    Ref<BroadcastChannel> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, BroadcastChannel& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
