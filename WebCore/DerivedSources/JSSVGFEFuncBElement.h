...
public:
    ...
    static JSSVGFEFuncBElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEFuncBElement>&& impl)
    {
        ...
        JSSVGFEFuncBElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEFuncBElement>(vm)) JSSVGFEFuncBElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEFuncBElement> protectedWrapped() const;
