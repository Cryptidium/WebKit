...
public:
    ...
    static JSSVGPathSegLinetoAbs* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegLinetoAbs>&& impl)
    {
        ...
        JSSVGPathSegLinetoAbs* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegLinetoAbs>(vm)) JSSVGPathSegLinetoAbs(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPathSegLinetoAbs> protectedWrapped() const;
