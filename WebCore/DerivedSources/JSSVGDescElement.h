...
public:
    ...
    static JSSVGDescElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGDescElement>&& impl)
    {
        ...
        JSSVGDescElement* ptr = new (NotNull, JSC::allocateCell<JSSVGDescElement>(vm)) JSSVGDescElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGDescElement> protectedWrapped() const;
