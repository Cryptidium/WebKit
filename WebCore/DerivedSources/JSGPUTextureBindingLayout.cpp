...
template<> ConversionResult<IDLDictionary<GPUTextureBindingLayout>> convertDictionary<GPUTextureBindingLayout>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    auto multisampledConversionResult = convertOptionalWithDefault<IDLBoolean>(lexicalGlobalObject, multisampledValue, [&]() -> ConversionResult<IDLBoolean> { return Converter<IDLBoolean>::ReturnType { false }; });
    if (multisampledConversionResult.hasException(throwScope)) [[unlikely]]
        return ConversionResultException { };
    result.multisampled = multisampledConversionResult.releaseReturnValue();
    ...
    if (sampleTypeConversionResult.hasException(throwScope)) [[unlikely]]
        return ConversionResultException { };
    result.sampleType = sampleTypeConversionResult.releaseReturnValue();
