...
public:
    ...
    static JSCSSPageRule* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSPageRule>&& impl)
    {
        ...
        JSCSSPageRule* ptr = new (NotNull, JSC::allocateCell<JSCSSPageRule>(vm)) JSCSSPageRule(structure, *globalObject, WTFMove(impl));
    ...
    Ref<CSSPageRule> protectedWrapped() const;
