...
static const std::array<HashTableValue, 2> JSEXTBlendMinMaxPrototypeTableValues {
    HashTableValue { "MIN_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8007 } },
    HashTableValue { "MAX_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8008 } },
};
...
{
    return WebCore::subspaceForImpl<JSEXTBlendMinMax, UseCustomHeapCellType::No>(vm, "JSEXTBlendMinMax"_s,
...
#endif
template<std::same_as<EXTBlendMinMax> T>
static inline void verifyVTable(EXTBlendMinMax* ptr) 
{
