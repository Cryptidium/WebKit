...
public:
    ...
    static JSMediaSession* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<MediaSession>&& impl)
    {
        ...
        JSMediaSession* ptr = new (NotNull, JSC::allocateCell<JSMediaSession>(vm)) JSMediaSession(structure, *globalObject, WTFMove(impl));
...
class WEBCORE_EXPORT JSMediaSessionOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, MediaSession& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
