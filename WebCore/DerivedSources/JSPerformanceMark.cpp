...
template<> EncodedJSValue JSC_HOST_CALL_ATTRIBUTES JSPerformanceMarkDOMConstructor::construct(JSGlobalObject* lexicalGlobalObject, CallFrame* callFrame)
{
    ...
    if (markOptionsConversionResult.hasException(throwScope)) [[unlikely]]
       return encodedJSValue();
    auto object = PerformanceMark::create(*castedThis->globalObject(), *context, markNameConversionResult.releaseReturnValue(), markOptionsConversionResult.releaseReturnValue());
...
static const std::array<HashTableValue, 2> JSPerformanceMarkPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsPerformanceMarkConstructor, 0 } },
    HashTableValue { "detail"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsPerformanceMark_detail, 0 } },
};
...
Ref<PerformanceMark> JSPerformanceMark::protectedWrapped() const
{
    return wrapped();
}
...
JSC_DEFINE_CUSTOM_GETTER(jsPerformanceMarkConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSPerformanceMark::getConstructor(vm, prototype->globalObject()));
}
...
{
    return WebCore::subspaceForImpl<JSPerformanceMark, UseCustomHeapCellType::No>(vm, "JSPerformanceMark"_s,
...
#endif
template<std::same_as<PerformanceMark> T>
static inline void verifyVTable(PerformanceMark* ptr) 
{
...
{
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<PerformanceMark>(impl.ptr());
#endif
