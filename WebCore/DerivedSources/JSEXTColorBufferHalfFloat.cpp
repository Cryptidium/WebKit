...
static const std::array<HashTableValue, 4> JSEXTColorBufferHalfFloatPrototypeTableValues {
    HashTableValue { "RGBA16F_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x881A } },
    HashTableValue { "RGB16F_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x881B } },
...
{
    return WebCore::subspaceForImpl<JSEXTColorBufferHalfFloat, UseCustomHeapCellType::No>(vm, "JSEXTColorBufferHalfFloat"_s,
...
bool JSEXTColorBufferHalfFloatOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, ASCIILiteral* reason)
{
    auto* jsEXTColorBufferHalfFloat = jsCast<JSEXTColorBufferHalfFloat*>(handle.slot()->asCell());
    auto& owner = jsEXTColorBufferHalfFloat->wrapped();
    if (reason) [[unlikely]]
        *reason = "Reachable from jsEXTColorBufferHalfFloat"_s;
...
void JSEXTColorBufferHalfFloatOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsEXTColorBufferHalfFloat->protectedWrapped().ptr(), jsEXTColorBufferHalfFloat);
}
...
#endif
template<std::same_as<EXTColorBufferHalfFloat> T>
static inline void verifyVTable(EXTColorBufferHalfFloat* ptr) 
{
...
{
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<EXTColorBufferHalfFloat>(impl.ptr());
#endif
