...
static const std::array<HashTableValue, 5> JSSVGPathSegCurvetoQuadraticAbsPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGPathSegCurvetoQuadraticAbsConstructor, 0 } },
    HashTableValue { "x"_s, JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGPathSegCurvetoQuadraticAbs_x, setJSSVGPathSegCurvetoQuadraticAbs_x } },
    HashTableValue { "y"_s, JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGPathSegCurvetoQuadraticAbs_y, setJSSVGPathSegCurvetoQuadraticAbs_y } },
    HashTableValue { "x1"_s, JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGPathSegCurvetoQuadraticAbs_x1, setJSSVGPathSegCurvetoQuadraticAbs_x1 } },
    HashTableValue { "y1"_s, JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGPathSegCurvetoQuadraticAbs_y1, setJSSVGPathSegCurvetoQuadraticAbs_y1 } },
};
...
{
    return WebCore::subspaceForImpl<JSSVGPathSegCurvetoQuadraticAbs, UseCustomHeapCellType::No>(vm, "JSSVGPathSegCurvetoQuadraticAbs"_s,
