...
{
    static constexpr std::array<std::pair<ComparableASCIILiteral, GPUVertexStepMode>, 2> mappings {
        std::pair<ComparableASCIILiteral, GPUVertexStepMode> { "instance"_s, GPUVertexStepMode::Instance },
        std::pair<ComparableASCIILiteral, GPUVertexStepMode> { "vertex"_s, GPUVertexStepMode::Vertex },
    };
