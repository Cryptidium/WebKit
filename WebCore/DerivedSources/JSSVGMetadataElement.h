...
public:
    ...
    static JSSVGMetadataElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGMetadataElement>&& impl)
    {
        ...
        JSSVGMetadataElement* ptr = new (NotNull, JSC::allocateCell<JSSVGMetadataElement>(vm)) JSSVGMetadataElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGMetadataElement> protectedWrapped() const;
