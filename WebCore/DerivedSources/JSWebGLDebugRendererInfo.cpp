...
static const std::array<HashTableValue, 2> JSWebGLDebugRendererInfoPrototypeTableValues {
    HashTableValue { "UNMASKED_VENDOR_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9245 } },
    HashTableValue { "UNMASKED_RENDERER_WEBGL"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x9246 } },
};
...
{
    return WebCore::subspaceForImpl<JSWebGLDebugRendererInfo, UseCustomHeapCellType::No>(vm, "JSWebGLDebugRendererInfo"_s,
...
bool JSWebGLDebugRendererInfoOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, ASCIILiteral* reason)
{
    auto* jsWebGLDebugRendererInfo = jsCast<JSWebGLDebugRendererInfo*>(handle.slot()->asCell());
    auto& owner = jsWebGLDebugRendererInfo->wrapped();
    if (reason) [[unlikely]]
        *reason = "Reachable from jsWebGLDebugRendererInfo"_s;
...
void JSWebGLDebugRendererInfoOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsWebGLDebugRendererInfo->protectedWrapped().ptr(), jsWebGLDebugRendererInfo);
}
...
#endif
template<std::same_as<WebGLDebugRendererInfo> T>
static inline void verifyVTable(WebGLDebugRendererInfo* ptr) 
{
...
{
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<WebGLDebugRendererInfo>(impl.ptr());
#endif
