...
static const std::array<HashTableValue, 1> JSUserMessageHandlersNamespacePrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsUserMessageHandlersNamespaceConstructor, 0 } },
};
...
JSC_DEFINE_CUSTOM_GETTER(jsUserMessageHandlersNamespaceConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSUserMessageHandlersNamespace::getConstructor(vm, prototype->globalObject()));
}

JSC::GCClient::IsoSubspace* JSUserMessageHandlersNamespace::subspaceForImpl(JSC::VM& vm)
{
    return WebCore::subspaceForImpl<JSUserMessageHandlersNamespace, UseCustomHeapCellType::No>(vm, "JSUserMessageHandlersNamespace"_s,
...
bool JSUserMessageHandlersNamespaceOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, ASCIILiteral* reason)
{
    UNUSED_PARAM(handle);
...
void JSUserMessageHandlersNamespaceOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsUserMessageHandlersNamespace->protectedWrapped().ptr(), jsUserMessageHandlersNamespace);
}
...
#endif
template<std::same_as<UserMessageHandlersNamespace> T>
static inline void verifyVTable(UserMessageHandlersNamespace* ptr) 
{
...
{
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<UserMessageHandlersNamespace>(impl.ptr());
#endif
