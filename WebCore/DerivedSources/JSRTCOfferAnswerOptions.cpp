...
template<> ConversionResult<IDLDictionary<RTCOfferAnswerOptions>> convertDictionary<RTCOfferAnswerOptions>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
