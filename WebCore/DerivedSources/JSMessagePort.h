...
public:
    ...
    static JSMessagePort* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<MessagePort>&& impl)
    {
        ...
        JSMessagePort* ptr = new (NotNull, JSC::allocateCell<JSMessagePort>(vm)) JSMessagePort(structure, *globalObject, WTFMove(impl));
    ...
    Ref<MessagePort> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, MessagePort& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
