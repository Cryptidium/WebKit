...
public:
    ...
    static JSSVGClipPathElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGClipPathElement>&& impl)
    {
        ...
        JSSVGClipPathElement* ptr = new (NotNull, JSC::allocateCell<JSSVGClipPathElement>(vm)) JSSVGClipPathElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGClipPathElement> protectedWrapped() const;
