...
public:
    ...
    static JSHTMLBodyElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLBodyElement>&& impl)
    {
        ...
        JSHTMLBodyElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLBodyElement>(vm)) JSHTMLBodyElement(structure, *globalObject, WTFMove(impl));
    ...
    static void forEachWindowEventHandlerContentAttribute(const Function<void(const AtomString& attributeName, const AtomString& eventName)>&);
    ...
    Ref<HTMLBodyElement> protectedWrapped() const;
