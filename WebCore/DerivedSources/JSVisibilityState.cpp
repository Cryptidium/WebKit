...
{
    static constexpr std::array<std::pair<ComparableASCIILiteral, VisibilityState>, 2> mappings {
        std::pair<ComparableASCIILiteral, VisibilityState> { "hidden"_s, VisibilityState::Hidden },
        std::pair<ComparableASCIILiteral, VisibilityState> { "visible"_s, VisibilityState::Visible },
    };
...
template<> ASCIILiteral expectedEnumerationValues<VisibilityState>()
{
    return "\"hidden\", \"visible\""_s;
}
