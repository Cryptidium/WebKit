...
public:
    ...
    static JSHTMLDetailsElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLDetailsElement>&& impl)
    {
        ...
        JSHTMLDetailsElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLDetailsElement>(vm)) JSHTMLDetailsElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLDetailsElement> protectedWrapped() const;
