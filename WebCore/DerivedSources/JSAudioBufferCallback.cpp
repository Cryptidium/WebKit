...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSAudioBufferCallback::invoke(typename IDLNullable<IDLInterface<AudioBuffer>>::ParameterType audioBuffer)
{
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSAudioBufferCallback::invokeRethrowingException(typename IDLNullable<IDLInterface<AudioBuffer>>::ParameterType audioBuffer)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
