...
template<> ConversionResult<IDLDictionary<XRCubeLayerInit>> convertDictionary<XRCubeLayerInit>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (spaceValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "space"_s, "XRCubeLayerInit"_s, "WebXRSpace"_s);
        return ConversionResultException { };
    }
    ...
    if (viewPixelHeightValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "viewPixelHeight"_s, "XRCubeLayerInit"_s, "unsigned long"_s);
        return ConversionResultException { };
    }
    ...
    if (viewPixelWidthValue.isUndefined()) {
        throwRequiredMemberTypeError(lexicalGlobalObject, throwScope, "viewPixelWidth"_s, "XRCubeLayerInit"_s, "unsigned long"_s);
        return ConversionResultException { };
    }
    ...
    JSValue orientationValue;
    if (isNullOrUndefined)
        orientationValue = jsUndefined();
    else {
        orientationValue = object->get(&lexicalGlobalObject, Identifier::fromString(vm, "orientation"_s));
        RETURN_IF_EXCEPTION(throwScope, ConversionResultException { });
    }
    if (!orientationValue.isUndefined()) {
        auto orientationConversionResult = convert<IDLNullable<IDLInterface<DOMPointReadOnly>>>(lexicalGlobalObject, orientationValue);
