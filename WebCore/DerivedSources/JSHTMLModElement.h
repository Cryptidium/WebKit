...
public:
    ...
    static JSHTMLModElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLModElement>&& impl)
    {
        ...
        JSHTMLModElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLModElement>(vm)) JSHTMLModElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLModElement> protectedWrapped() const;
