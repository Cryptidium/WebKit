...
template<> ConversionResult<IDLDictionary<PaymentRequestUpdateEventInit>> convertDictionary<PaymentRequestUpdateEventInit>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
