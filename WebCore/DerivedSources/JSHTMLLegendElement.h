...
public:
    ...
    static JSHTMLLegendElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLLegendElement>&& impl)
    {
        ...
        JSHTMLLegendElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLLegendElement>(vm)) JSHTMLLegendElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLLegendElement> protectedWrapped() const;
