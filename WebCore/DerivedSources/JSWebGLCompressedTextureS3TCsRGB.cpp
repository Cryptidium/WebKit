...
static const std::array<HashTableValue, 4> JSWebGLCompressedTextureS3TCsRGBPrototypeTableValues {
    HashTableValue { "COMPRESSED_SRGB_S3TC_DXT1_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8C4C } },
    HashTableValue { "COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8C4D } },
    HashTableValue { "COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8C4E } },
    HashTableValue { "COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x8C4F } },
};
...
{
    return WebCore::subspaceForImpl<JSWebGLCompressedTextureS3TCsRGB, UseCustomHeapCellType::No>(vm, "JSWebGLCompressedTextureS3TCsRGB"_s,
...
bool JSWebGLCompressedTextureS3TCsRGBOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, ASCIILiteral* reason)
{
    ...
    if (reason) [[unlikely]]
        *reason = "Reachable from jsWebGLCompressedTextureS3TCsRGB"_s;
...
void JSWebGLCompressedTextureS3TCsRGBOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsWebGLCompressedTextureS3TCsRGB->protectedWrapped().ptr(), jsWebGLCompressedTextureS3TCsRGB);
}
...
#endif
template<std::same_as<WebGLCompressedTextureS3TCsRGB> T>
static inline void verifyVTable(WebGLCompressedTextureS3TCsRGB* ptr) 
{
...
{
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<WebGLCompressedTextureS3TCsRGB>(impl.ptr());
#endif
