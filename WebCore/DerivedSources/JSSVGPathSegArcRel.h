...
public:
    ...
    static JSSVGPathSegArcRel* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegArcRel>&& impl)
    {
        ...
        JSSVGPathSegArcRel* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegArcRel>(vm)) JSSVGPathSegArcRel(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPathSegArcRel> protectedWrapped() const;
