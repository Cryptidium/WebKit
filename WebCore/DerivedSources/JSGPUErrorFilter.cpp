...
{
    static constexpr std::array<std::pair<ComparableASCIILiteral, GPUErrorFilter>, 3> mappings {
        std::pair<ComparableASCIILiteral, GPUErrorFilter> { "internal"_s, GPUErrorFilter::Internal },
        std::pair<ComparableASCIILiteral, GPUErrorFilter> { "out-of-memory"_s, GPUErrorFilter::OutOfMemory },
        std::pair<ComparableASCIILiteral, GPUErrorFilter> { "validation"_s, GPUErrorFilter::Validation },
    };
