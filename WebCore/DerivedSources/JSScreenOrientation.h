...
public:
    ...
    static JSScreenOrientation* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<ScreenOrientation>&& impl)
    {
        ...
        JSScreenOrientation* ptr = new (NotNull, JSC::allocateCell<JSScreenOrientation>(vm)) JSScreenOrientation(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, ScreenOrientation& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
