...
template<> ConversionResult<IDLDictionary<OscillatorOptions>> convertDictionary<OscillatorOptions>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    auto frequencyConversionResult = convertOptionalWithDefault<IDLFloat>(lexicalGlobalObject, frequencyValue, [&]() -> ConversionResult<IDLFloat> { return Converter<IDLFloat>::ReturnType { 440 }; });
    ...
    if (!periodicWaveValue.isUndefined()) {
        auto periodicWaveConversionResult = convert<IDLInterface<PeriodicWave>>(lexicalGlobalObject, periodicWaveValue);
        if (periodicWaveConversionResult.hasException(throwScope)) [[unlikely]]
            return ConversionResultException { };
        result.periodicWave = periodicWaveConversionResult.releaseReturnValue();
    }
    JSValue typeValue;
    if (isNullOrUndefined)
    ...
    auto typeConversionResult = convertOptionalWithDefault<IDLEnumeration<OscillatorType>>(lexicalGlobalObject, typeValue, [&]() -> ConversionResult<IDLEnumeration<OscillatorType>> { return Converter<IDLEnumeration<OscillatorType>>::ReturnType { OscillatorType::Sine }; });
