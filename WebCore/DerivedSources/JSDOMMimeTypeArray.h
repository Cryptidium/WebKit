...
public:
    ...
    static JSDOMMimeTypeArray* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<DOMMimeTypeArray>&& impl)
    {
        ...
        JSDOMMimeTypeArray* ptr = new (NotNull, JSC::allocateCell<JSDOMMimeTypeArray>(vm)) JSDOMMimeTypeArray(structure, *globalObject, WTFMove(impl));
...
class JSDOMMimeTypeArrayOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, DOMMimeTypeArray& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
