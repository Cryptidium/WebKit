...
public:
    ...
    static JSSVGFEDiffuseLightingElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEDiffuseLightingElement>&& impl)
    {
        ...
        JSSVGFEDiffuseLightingElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEDiffuseLightingElement>(vm)) JSSVGFEDiffuseLightingElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEDiffuseLightingElement> protectedWrapped() const;
