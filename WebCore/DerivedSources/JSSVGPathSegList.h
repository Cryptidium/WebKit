...
public:
    ...
    static JSSVGPathSegList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegList>&& impl)
    {
        ...
        JSSVGPathSegList* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegList>(vm)) JSSVGPathSegList(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, SVGPathSegList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
