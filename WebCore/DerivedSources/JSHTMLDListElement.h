...
public:
    ...
    static JSHTMLDListElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLDListElement>&& impl)
    {
        ...
        JSHTMLDListElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLDListElement>(vm)) JSHTMLDListElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLDListElement> protectedWrapped() const;
