...
template<> ConversionResult<IDLDictionary<ElementCreationOptions>> convertDictionary<ElementCreationOptions>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
