...
public:
    ...
    static JSErrorEvent* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<ErrorEvent>&& impl)
    {
        ...
        JSErrorEvent* ptr = new (NotNull, JSC::allocateCell<JSErrorEvent>(vm)) JSErrorEvent(structure, *globalObject, WTFMove(impl));
    ...
    Ref<ErrorEvent> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, ErrorEvent& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> ConversionResult<IDLDictionary<ErrorEvent::Init>> convertDictionary<ErrorEvent::Init>(JSC::JSGlobalObject&, JSC::JSValue);
