...
public:
    ...
    static JSSVGAnimateTransformElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGAnimateTransformElement>&& impl)
    {
        ...
        JSSVGAnimateTransformElement* ptr = new (NotNull, JSC::allocateCell<JSSVGAnimateTransformElement>(vm)) JSSVGAnimateTransformElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGAnimateTransformElement> protectedWrapped() const;
