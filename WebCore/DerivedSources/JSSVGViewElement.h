...
public:
    ...
    static JSSVGViewElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGViewElement>&& impl)
    {
        ...
        JSSVGViewElement* ptr = new (NotNull, JSC::allocateCell<JSSVGViewElement>(vm)) JSSVGViewElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGViewElement> protectedWrapped() const;
