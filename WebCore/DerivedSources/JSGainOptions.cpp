...
template<> ConversionResult<IDLDictionary<GainOptions>> convertDictionary<GainOptions>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    auto gainConversionResult = convertOptionalWithDefault<IDLFloat>(lexicalGlobalObject, gainValue, [&]() -> ConversionResult<IDLFloat> { return Converter<IDLFloat>::ReturnType { 1.0 }; });
