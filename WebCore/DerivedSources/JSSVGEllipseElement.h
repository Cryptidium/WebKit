...
public:
    ...
    static JSSVGEllipseElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGEllipseElement>&& impl)
    {
        ...
        JSSVGEllipseElement* ptr = new (NotNull, JSC::allocateCell<JSSVGEllipseElement>(vm)) JSSVGEllipseElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGEllipseElement> protectedWrapped() const;
