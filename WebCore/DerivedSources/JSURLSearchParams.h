...
public:
    ...
    static JSURLSearchParams* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<URLSearchParams>&& impl)
    {
        ...
        JSURLSearchParams* ptr = new (NotNull, JSC::allocateCell<JSURLSearchParams>(vm)) JSURLSearchParams(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, URLSearchParams& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
