...
static const std::array<HashTableValue, 3> JSSVGAnimatedLengthListPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGAnimatedLengthListConstructor, 0 } },
    HashTableValue { "baseVal"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGAnimatedLengthList_baseVal, 0 } },
    HashTableValue { "animVal"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGAnimatedLengthList_animVal, 0 } },
};
...
JSC_DEFINE_CUSTOM_GETTER(jsSVGAnimatedLengthListConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSSVGAnimatedLengthList::getConstructor(vm, prototype->globalObject()));
}
...
{
    return WebCore::subspaceForImpl<JSSVGAnimatedLengthList, UseCustomHeapCellType::No>(vm, "JSSVGAnimatedLengthList"_s,
...
bool JSSVGAnimatedLengthListOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, ASCIILiteral* reason)
{
    UNUSED_PARAM(handle);
...
void JSSVGAnimatedLengthListOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsSVGAnimatedLengthList->protectedWrapped().ptr(), jsSVGAnimatedLengthList);
}
