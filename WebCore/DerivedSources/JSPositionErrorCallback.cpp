...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSPositionErrorCallback::invoke(typename IDLInterface<GeolocationPositionError>::ParameterType error)
{
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSPositionErrorCallback::invokeRethrowingException(typename IDLInterface<GeolocationPositionError>::ParameterType error)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
