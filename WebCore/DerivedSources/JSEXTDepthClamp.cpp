...
static const std::array<HashTableValue, 1> JSEXTDepthClampPrototypeTableValues {
    HashTableValue { "DEPTH_CLAMP_EXT"_s, PropertyAttribute::ReadOnly | PropertyAttribute::DontDelete | PropertyAttribute::ConstantInteger, NoIntrinsic, { HashTableValue::ConstantType, 0x864F } },
};
...
{
    return WebCore::subspaceForImpl<JSEXTDepthClamp, UseCustomHeapCellType::No>(vm, "JSEXTDepthClamp"_s,
...
#endif
template<std::same_as<EXTDepthClamp> T>
static inline void verifyVTable(EXTDepthClamp* ptr) 
{
