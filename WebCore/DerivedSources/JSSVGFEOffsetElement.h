...
public:
    ...
    static JSSVGFEOffsetElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEOffsetElement>&& impl)
    {
        ...
        JSSVGFEOffsetElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEOffsetElement>(vm)) JSSVGFEOffsetElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEOffsetElement> protectedWrapped() const;
