...
template<> JSString* convertEnumerationToJS(VM& vm, CryptoKey::Type enumerationValue)
{
    return jsStringWithCache(vm, convertEnumerationToString(enumerationValue));
}

template<> std::optional<CryptoKey::Type> parseEnumerationFromString<CryptoKey::Type>(const String& stringValue)
{
    static constexpr std::array<std::pair<ComparableASCIILiteral, CryptoKey::Type>, 3> mappings {
        std::pair<ComparableASCIILiteral, CryptoKey::Type> { "private"_s, CryptoKey::Type::Private },
        std::pair<ComparableASCIILiteral, CryptoKey::Type> { "public"_s, CryptoKey::Type::Public },
        std::pair<ComparableASCIILiteral, CryptoKey::Type> { "secret"_s, CryptoKey::Type::Secret },
    };
...
{
    return parseEnumerationFromString<CryptoKey::Type>(value.toWTFString(&lexicalGlobalObject));
}
...
static const std::array<HashTableValue, 5> JSCryptoKeyPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsCryptoKeyConstructor, 0 } },
    HashTableValue { "type"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsCryptoKey_type, 0 } },
    HashTableValue { "extractable"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsCryptoKey_extractable, 0 } },
    HashTableValue { "algorithm"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsCryptoKey_algorithm, 0 } },
    HashTableValue { "usages"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsCryptoKey_usages, 0 } },
};
...
JSC_DEFINE_CUSTOM_GETTER(jsCryptoKeyConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSCryptoKey::getConstructor(vm, prototype->globalObject()));
}
...
{
    return WebCore::subspaceForImpl<JSCryptoKey, UseCustomHeapCellType::No>(vm, "JSCryptoKey"_s,
...
bool JSCryptoKeyOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, ASCIILiteral* reason)
{
...
void JSCryptoKeyOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsCryptoKey->protectedWrapped().ptr(), jsCryptoKey);
}
