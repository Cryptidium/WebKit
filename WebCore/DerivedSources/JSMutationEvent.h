...
public:
    ...
    static JSMutationEvent* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<MutationEvent>&& impl)
    {
        ...
        JSMutationEvent* ptr = new (NotNull, JSC::allocateCell<JSMutationEvent>(vm)) JSMutationEvent(structure, *globalObject, WTFMove(impl));
    ...
    Ref<MutationEvent> protectedWrapped() const;
