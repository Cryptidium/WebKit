...
public:
    ...
    static JSSVGMarkerElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGMarkerElement>&& impl)
    {
        ...
        JSSVGMarkerElement* ptr = new (NotNull, JSC::allocateCell<JSSVGMarkerElement>(vm)) JSSVGMarkerElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGMarkerElement> protectedWrapped() const;
