...
public:
    ...
    static JSHTMLDataListElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLDataListElement>&& impl)
    {
        ...
        JSHTMLDataListElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLDataListElement>(vm)) JSHTMLDataListElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLDataListElement> protectedWrapped() const;
