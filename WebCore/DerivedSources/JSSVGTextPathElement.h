...
public:
    ...
    static JSSVGTextPathElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGTextPathElement>&& impl)
    {
        ...
        JSSVGTextPathElement* ptr = new (NotNull, JSC::allocateCell<JSSVGTextPathElement>(vm)) JSSVGTextPathElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGTextPathElement> protectedWrapped() const;
