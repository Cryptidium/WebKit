...
public:
    ...
    static JSHTMLAnchorElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLAnchorElement>&& impl)
    {
        ...
        JSHTMLAnchorElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLAnchorElement>(vm)) JSHTMLAnchorElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLAnchorElement> protectedWrapped() const;
