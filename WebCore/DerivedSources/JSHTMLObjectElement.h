...
public:
    ...
    static JSHTMLObjectElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLObjectElement>&& impl)
    {
        ...
        JSHTMLObjectElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLObjectElement>(vm)) JSHTMLObjectElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLObjectElement> protectedWrapped() const;
