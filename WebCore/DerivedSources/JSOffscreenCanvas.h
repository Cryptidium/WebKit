...
public:
    ...
    static JSOffscreenCanvas* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<OffscreenCanvas>&& impl)
    {
        ...
        JSOffscreenCanvas* ptr = new (NotNull, JSC::allocateCell<JSOffscreenCanvas>(vm)) JSOffscreenCanvas(structure, *globalObject, WTFMove(impl));
    ...
    Ref<OffscreenCanvas> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, OffscreenCanvas& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> JSC::JSString* convertEnumerationToJS(JSC::VM&, OffscreenCanvas::RenderingContextType);

template<> std::optional<OffscreenCanvas::RenderingContextType> parseEnumerationFromString<OffscreenCanvas::RenderingContextType>(const String&);
...
template<> ConversionResult<IDLDictionary<OffscreenCanvas::ImageEncodeOptions>> convertDictionary<OffscreenCanvas::ImageEncodeOptions>(JSC::JSGlobalObject&, JSC::JSValue);
