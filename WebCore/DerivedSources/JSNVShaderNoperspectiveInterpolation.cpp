...
{
    return WebCore::subspaceForImpl<JSNVShaderNoperspectiveInterpolation, UseCustomHeapCellType::No>(vm, "JSNVShaderNoperspectiveInterpolation"_s,
...
#endif
template<std::same_as<NVShaderNoperspectiveInterpolation> T>
static inline void verifyVTable(NVShaderNoperspectiveInterpolation* ptr) 
{
