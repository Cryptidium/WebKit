...
public:
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCookieChangeEvent;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCookieStore;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCookieStoreManager;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForExtendableCookieChangeEvent;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForFileSystemWritableFileStream;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForHighlightRegistry;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForDigitalCredential;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForMediaSourceHandle;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForImageCapture;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForMediaStreamTrackProcessor;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForVideoTrackGenerator;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForIntegrityPolicyViolationReportBody;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebCodecsAudioData;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebCodecsAudioDecoder;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebCodecsAudioEncoder;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebCodecsEncodedAudioChunk;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebTransport;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebTransportBidirectionalStream;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebTransportDatagramDuplexStream;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebTransportError;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebTransportReceiveStream;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebTransportSendStream;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXRCompositionLayer;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXRCubeLayer;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXRCylinderLayer;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXREquirectLayer;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXRGPUBinding;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXRGPUSubImage;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXRLayerEvent;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXRProjectionLayer;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXRQuadLayer;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXRSubImage;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXRWebGLBinding;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForXRWebGLSubImage;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForScrollTimeline;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForViewTimeline;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSFontFaceDescriptors;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSNestedDeclarations;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSPageDescriptors;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSPositionTryDescriptors;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSPositionTryRule;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSScopeRule;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSStartingStyleRule;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSStyleDeclaration;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSStyleProperties;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSViewTransitionRule;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSOMColor;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCSSOMColorValue;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCaretPosition;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCommandEvent;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForContentVisibilityAutoStateChangeEvent;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCustomStateSet;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForObservable;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForOverflowEvent;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForPageRevealEvent;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForPageSwapEvent;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForSubscriber;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForTrustedHTML;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForTrustedScript;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForTrustedScriptURL;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForTrustedTypePolicy;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForTrustedTypePolicyFactory;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForUIEvent;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForViewTransition;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForViewTransitionTypeSet;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebGLBlendFuncExtended;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForCloseWatcher;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForEventCounts;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForEventSource;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForFragmentDirective;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForNavigateEvent;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForNavigation;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForNavigationActivation;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForNavigationCurrentEntryChangeEvent;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForNavigationDestination;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForNavigationHistoryEntry;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForNavigationTransition;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForNavigator;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForNavigatorUAData;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForPerformanceEventTiming;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebKitNodeInfo;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebKitPoint;
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForWebKitSerializedNode;
    ...
    std::unique_ptr<GCClient::IsoSubspace> m_clientSubspaceForInstallEvent;
