...
public:
    ...
    static JSHTMLIFrameElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLIFrameElement>&& impl)
    {
        ...
        JSHTMLIFrameElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLIFrameElement>(vm)) JSHTMLIFrameElement(structure, *globalObject, WTFMove(impl));
    ...
    static HTMLIFrameElement* toWrapped(JSC::VM&, JSC::JSValue);
    ...
    Ref<HTMLIFrameElement> protectedWrapped() const;
