...
JSStringCallback::JSStringCallback(JSObject* callback, JSDOMGlobalObject* globalObject)
    : StringCallback(globalObject->scriptExecutionContext())
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSStringCallback::invoke(typename IDLDOMString::ParameterType data)
{
    ...
    args.append(toJS<IDLDOMString>(lexicalGlobalObject, data));
...
CallbackResult<typename IDLUndefined::CallbackReturnType> JSStringCallback::invokeRethrowingException(typename IDLDOMString::ParameterType data)
{
    if (!canInvokeCallback())
        return CallbackResultType::UnableToExecute;
