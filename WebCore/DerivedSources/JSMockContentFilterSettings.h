...
public:
    ...
    static JSMockContentFilterSettings* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<MockContentFilterSettings>&& impl)
    {
        ...
        JSMockContentFilterSettings* ptr = new (NotNull, JSC::allocateCell<JSMockContentFilterSettings>(vm)) JSMockContentFilterSettings(structure, *globalObject, WTFMove(impl));
...
class JSMockContentFilterSettingsOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, MockContentFilterSettings& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
...
template<> JSC::JSString* convertEnumerationToJS(JSC::VM&, MockContentFilterSettings::DecisionPoint);

template<> std::optional<MockContentFilterSettings::DecisionPoint> parseEnumerationFromString<MockContentFilterSettings::DecisionPoint>(const String&);
template<> std::optional<MockContentFilterSettings::DecisionPoint> parseEnumeration<MockContentFilterSettings::DecisionPoint>(JSC::JSGlobalObject&, JSC::JSValue);
...
template<> JSC::JSString* convertEnumerationToJS(JSC::VM&, MockContentFilterSettings::Decision);

template<> std::optional<MockContentFilterSettings::Decision> parseEnumerationFromString<MockContentFilterSettings::Decision>(const String&);
template<> std::optional<MockContentFilterSettings::Decision> parseEnumeration<MockContentFilterSettings::Decision>(JSC::JSGlobalObject&, JSC::JSValue);
