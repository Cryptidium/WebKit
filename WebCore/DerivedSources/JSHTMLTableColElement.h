...
public:
    ...
    static JSHTMLTableColElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLTableColElement>&& impl)
    {
        ...
        JSHTMLTableColElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLTableColElement>(vm)) JSHTMLTableColElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLTableColElement> protectedWrapped() const;
