...
template<> ConversionResult<IDLDictionary<CredentialCreationOptions>> convertDictionary<CredentialCreationOptions>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
    ...
    if (!publicKeyValue.isUndefined()) {
        auto publicKeyConversionResult = convert<IDLDictionary<PublicKeyCredentialCreationOptions>>(lexicalGlobalObject, publicKeyValue);
