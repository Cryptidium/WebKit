...
public:
    ...
    static JSSVGFEDropShadowElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEDropShadowElement>&& impl)
    {
        ...
        JSSVGFEDropShadowElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEDropShadowElement>(vm)) JSSVGFEDropShadowElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEDropShadowElement> protectedWrapped() const;
