...
public:
    ...
    static JSHTMLFrameElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLFrameElement>&& impl)
    {
        ...
        JSHTMLFrameElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLFrameElement>(vm)) JSHTMLFrameElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLFrameElement> protectedWrapped() const;
