...
public:
    ...
    static JSSVGTransformList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGTransformList>&& impl)
    {
        ...
        JSSVGTransformList* ptr = new (NotNull, JSC::allocateCell<JSSVGTransformList>(vm)) JSSVGTransformList(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, SVGTransformList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
