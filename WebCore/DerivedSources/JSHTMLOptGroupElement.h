...
public:
    ...
    static JSHTMLOptGroupElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLOptGroupElement>&& impl)
    {
        ...
        JSHTMLOptGroupElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLOptGroupElement>(vm)) JSHTMLOptGroupElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLOptGroupElement> protectedWrapped() const;
