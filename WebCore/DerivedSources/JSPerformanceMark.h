...
public:
    ...
    static JSPerformanceMark* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<PerformanceMark>&& impl)
    {
        ...
        JSPerformanceMark* ptr = new (NotNull, JSC::allocateCell<JSPerformanceMark>(vm)) JSPerformanceMark(structure, *globalObject, WTFMove(impl));
    ...
    Ref<PerformanceMark> protectedWrapped() const;
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, PerformanceMark& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
