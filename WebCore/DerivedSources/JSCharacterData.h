...
public:
    ...
    static JSCharacterData* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CharacterData>&& impl)
    {
        ...
        JSCharacterData* ptr = new (NotNull, JSC::allocateCell<JSCharacterData>(vm)) JSCharacterData(structure, *globalObject, WTFMove(impl));
    ...
    Ref<CharacterData> protectedWrapped() const;
