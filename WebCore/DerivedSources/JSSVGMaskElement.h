...
public:
    ...
    static JSSVGMaskElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGMaskElement>&& impl)
    {
        ...
        JSSVGMaskElement* ptr = new (NotNull, JSC::allocateCell<JSSVGMaskElement>(vm)) JSSVGMaskElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGMaskElement> protectedWrapped() const;
