...
public:
    ...
    static JSSVGDefsElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGDefsElement>&& impl)
    {
        ...
        JSSVGDefsElement* ptr = new (NotNull, JSC::allocateCell<JSSVGDefsElement>(vm)) JSSVGDefsElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGDefsElement> protectedWrapped() const;
