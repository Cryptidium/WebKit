...
public:
    ...
    static JSHTMLHRElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLHRElement>&& impl)
    {
        ...
        JSHTMLHRElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLHRElement>(vm)) JSHTMLHRElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLHRElement> protectedWrapped() const;
