...
{
    static constexpr std::array<std::pair<ComparableASCIILiteral, RTCIceCandidateType>, 4> mappings {
        std::pair<ComparableASCIILiteral, RTCIceCandidateType> { "host"_s, RTCIceCandidateType::Host },
        std::pair<ComparableASCIILiteral, RTCIceCandidateType> { "prflx"_s, RTCIceCandidateType::Prflx },
        std::pair<ComparableASCIILiteral, RTCIceCandidateType> { "relay"_s, RTCIceCandidateType::Relay },
        std::pair<ComparableASCIILiteral, RTCIceCandidateType> { "srflx"_s, RTCIceCandidateType::Srflx },
    };
...
template<> ASCIILiteral expectedEnumerationValues<RTCIceCandidateType>()
{
    return "\"host\", \"srflx\", \"prflx\", \"relay\""_s;
}
