...
public:
    ...
    static JSTextTrackList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<TextTrackList>&& impl)
    {
        ...
        JSTextTrackList* ptr = new (NotNull, JSC::allocateCell<JSTextTrackList>(vm)) JSTextTrackList(structure, *globalObject, WTFMove(impl));
    ...
    Ref<TextTrackList> protectedWrapped() const;
...
class JSTextTrackListOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, TextTrackList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
