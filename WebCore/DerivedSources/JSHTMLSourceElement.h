...
public:
    ...
    static JSHTMLSourceElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLSourceElement>&& impl)
    {
        ...
        JSHTMLSourceElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLSourceElement>(vm)) JSHTMLSourceElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLSourceElement> protectedWrapped() const;
...
class JSHTMLSourceElementOwner final : public JSNodeOwner {
public:
