...
public:
    ...
    static JSDOMTokenList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<DOMTokenList>&& impl)
    {
        ...
        JSDOMTokenList* ptr = new (NotNull, JSC::allocateCell<JSDOMTokenList>(vm)) JSDOMTokenList(structure, *globalObject, WTFMove(impl));
...
class JSDOMTokenListOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, DOMTokenList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
