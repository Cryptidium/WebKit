...
static const std::array<HashTableValue, 1> JSTextEncoderStreamEncoderPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsTextEncoderStreamEncoderConstructor, 0 } },
};
...
static inline JSC::EncodedJSValue jsTextEncoderStreamEncoderPrototypeFunction_encodeBody(JSC::JSGlobalObject* lexicalGlobalObject, JSC::CallFrame* callFrame, typename IDLOperation<JSTextEncoderStreamEncoder>::ClassParameter castedThis)
{
    ...
    auto chunkConversionResult = convert<IDLDOMString>(*lexicalGlobalObject, argument0.value());
...
{
    return WebCore::subspaceForImpl<JSTextEncoderStreamEncoder, UseCustomHeapCellType::No>(vm, "JSTextEncoderStreamEncoder"_s,
...
#endif
template<std::same_as<TextEncoderStreamEncoder> T>
static inline void verifyVTable(TextEncoderStreamEncoder* ptr) 
{
