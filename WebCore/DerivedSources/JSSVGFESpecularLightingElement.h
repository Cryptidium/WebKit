...
public:
    ...
    static JSSVGFESpecularLightingElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFESpecularLightingElement>&& impl)
    {
        ...
        JSSVGFESpecularLightingElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFESpecularLightingElement>(vm)) JSSVGFESpecularLightingElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFESpecularLightingElement> protectedWrapped() const;
