...
public:
    ...
    static JSSVGFEFuncAElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGFEFuncAElement>&& impl)
    {
        ...
        JSSVGFEFuncAElement* ptr = new (NotNull, JSC::allocateCell<JSSVGFEFuncAElement>(vm)) JSSVGFEFuncAElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGFEFuncAElement> protectedWrapped() const;
