...
static const std::array<HashTableValue, 3> JSSVGAnimatedLengthPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGAnimatedLengthConstructor, 0 } },
    HashTableValue { "baseVal"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGAnimatedLength_baseVal, 0 } },
    HashTableValue { "animVal"_s, JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGAnimatedLength_animVal, 0 } },
};
...
JSC_DEFINE_CUSTOM_GETTER(jsSVGAnimatedLengthConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSSVGAnimatedLength::getConstructor(vm, prototype->globalObject()));
}
...
{
    return WebCore::subspaceForImpl<JSSVGAnimatedLength, UseCustomHeapCellType::No>(vm, "JSSVGAnimatedLength"_s,
...
bool JSSVGAnimatedLengthOwner::isReachableFromOpaqueRoots(JSC::Handle<JSC::Unknown> handle, void*, AbstractSlotVisitor& visitor, ASCIILiteral* reason)
{
    UNUSED_PARAM(handle);
...
void JSSVGAnimatedLengthOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsSVGAnimatedLength->protectedWrapped().ptr(), jsSVGAnimatedLength);
}
