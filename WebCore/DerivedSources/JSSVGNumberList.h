...
public:
    ...
    static JSSVGNumberList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGNumberList>&& impl)
    {
        ...
        JSSVGNumberList* ptr = new (NotNull, JSC::allocateCell<JSSVGNumberList>(vm)) JSSVGNumberList(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, SVGNumberList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
