...
public:
    ...
    static JSHTMLUnknownElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLUnknownElement>&& impl)
    {
        ...
        JSHTMLUnknownElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLUnknownElement>(vm)) JSHTMLUnknownElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLUnknownElement> protectedWrapped() const;
