...
public:
    ...
    static JSPaymentResponse* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<PaymentResponse>&& impl)
    {
        ...
        JSPaymentResponse* ptr = new (NotNull, JSC::allocateCell<JSPaymentResponse>(vm)) JSPaymentResponse(structure, *globalObject, WTFMove(impl));
    ...
    Ref<PaymentResponse> protectedWrapped() const;
...
class JSPaymentResponseOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, PaymentResponse& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
