...
static const std::array<HashTableValue, 4> JSPerformanceObserverEntryListPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsPerformanceObserverEntryListConstructor, 0 } },
    HashTableValue { "getEntries"_s, static_cast<unsigned>(JSC::PropertyAttribute::Function), NoIntrinsic, { HashTableValue::NativeFunctionType, jsPerformanceObserverEntryListPrototypeFunction_getEntries, 0 } },
    HashTableValue { "getEntriesByType"_s, static_cast<unsigned>(JSC::PropertyAttribute::Function), NoIntrinsic, { HashTableValue::NativeFunctionType, jsPerformanceObserverEntryListPrototypeFunction_getEntriesByType, 1 } },
    HashTableValue { "getEntriesByName"_s, static_cast<unsigned>(JSC::PropertyAttribute::Function), NoIntrinsic, { HashTableValue::NativeFunctionType, jsPerformanceObserverEntryListPrototypeFunction_getEntriesByName, 1 } },
};
...
JSC_DEFINE_CUSTOM_GETTER(jsPerformanceObserverEntryListConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSPerformanceObserverEntryList::getConstructor(vm, prototype->globalObject()));
}
...
{
    return WebCore::subspaceForImpl<JSPerformanceObserverEntryList, UseCustomHeapCellType::No>(vm, "JSPerformanceObserverEntryList"_s,
...
void JSPerformanceObserverEntryListOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    uncacheWrapper(world, jsPerformanceObserverEntryList->protectedWrapped().ptr(), jsPerformanceObserverEntryList);
}
...
#endif
template<std::same_as<PerformanceObserverEntryList> T>
static inline void verifyVTable(PerformanceObserverEntryList* ptr) 
{
...
{
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<PerformanceObserverEntryList>(impl.ptr());
#endif
