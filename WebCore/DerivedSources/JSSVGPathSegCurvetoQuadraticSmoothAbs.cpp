...
static const std::array<HashTableValue, 3> JSSVGPathSegCurvetoQuadraticSmoothAbsPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGPathSegCurvetoQuadraticSmoothAbsConstructor, 0 } },
    HashTableValue { "x"_s, JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGPathSegCurvetoQuadraticSmoothAbs_x, setJSSVGPathSegCurvetoQuadraticSmoothAbs_x } },
    HashTableValue { "y"_s, JSC::PropertyAttribute::CustomAccessor | JSC::PropertyAttribute::DOMAttribute, NoIntrinsic, { HashTableValue::GetterSetterType, jsSVGPathSegCurvetoQuadraticSmoothAbs_y, setJSSVGPathSegCurvetoQuadraticSmoothAbs_y } },
};
...
JSC_DEFINE_CUSTOM_GETTER(jsSVGPathSegCurvetoQuadraticSmoothAbsConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSSVGPathSegCurvetoQuadraticSmoothAbs::getConstructor(vm, prototype->globalObject()));
}
...
{
    return WebCore::subspaceForImpl<JSSVGPathSegCurvetoQuadraticSmoothAbs, UseCustomHeapCellType::No>(vm, "JSSVGPathSegCurvetoQuadraticSmoothAbs"_s,
