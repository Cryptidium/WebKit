...
template<> ConversionResult<IDLDictionary<CryptoAlgorithmEcdhKeyDeriveParams>> convertDictionary<CryptoAlgorithmEcdhKeyDeriveParams>(JSGlobalObject& lexicalGlobalObject, JSValue value)
{
