...
public:
    ...
    static JSTextTrackCue* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<TextTrackCue>&& impl)
    {
        ...
        JSTextTrackCue* ptr = new (NotNull, JSC::allocateCell<JSTextTrackCue>(vm)) JSTextTrackCue(structure, *globalObject, WTFMove(impl));
    ...
    Ref<TextTrackCue> protectedWrapped() const;
...
class JSTextTrackCueOwner final : public JSC::WeakHandleOwner {
public:
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, TextTrackCue& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
