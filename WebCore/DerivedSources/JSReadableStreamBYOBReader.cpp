...
static const std::array<HashTableValue, 5> JSReadableStreamBYOBReaderPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsReadableStreamBYOBReaderConstructor, 0 } },
    HashTableValue { "closed"_s, JSC::PropertyAttribute::DontEnum | JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::Accessor | JSC::PropertyAttribute::Builtin, NoIntrinsic, { HashTableValue::BuiltinAccessorType, readableStreamBYOBReaderClosedCodeGenerator, 0 } },
    HashTableValue { "read"_s, JSC::PropertyAttribute::DontEnum | JSC::PropertyAttribute::Builtin, NoIntrinsic, { HashTableValue::BuiltinGeneratorType, readableStreamBYOBReaderReadCodeGenerator, 0 } },
    HashTableValue { "cancel"_s, JSC::PropertyAttribute::DontEnum | JSC::PropertyAttribute::Builtin, NoIntrinsic, { HashTableValue::BuiltinGeneratorType, readableStreamBYOBReaderCancelCodeGenerator, 0 } },
    HashTableValue { "releaseLock"_s, JSC::PropertyAttribute::DontEnum | JSC::PropertyAttribute::Builtin, NoIntrinsic, { HashTableValue::BuiltinGeneratorType, readableStreamBYOBReaderReleaseLockCodeGenerator, 0 } },
};
...
{
    return WebCore::subspaceForImpl<JSReadableStreamBYOBReader, UseCustomHeapCellType::No>(vm, "JSReadableStreamBYOBReader"_s,
