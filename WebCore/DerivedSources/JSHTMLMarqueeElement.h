...
public:
    ...
    static JSHTMLMarqueeElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLMarqueeElement>&& impl)
    {
        ...
        JSHTMLMarqueeElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLMarqueeElement>(vm)) JSHTMLMarqueeElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLMarqueeElement> protectedWrapped() const;
...
class JSHTMLMarqueeElementOwner final : public JSNodeOwner {
public:
