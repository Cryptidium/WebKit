...
public:
    ...
    static JSPerformanceObserverEntryList* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<PerformanceObserverEntryList>&& impl)
    {
        ...
        JSPerformanceObserverEntryList* ptr = new (NotNull, JSC::allocateCell<JSPerformanceObserverEntryList>(vm)) JSPerformanceObserverEntryList(structure, *globalObject, WTFMove(impl));
...
ALWAYS_INLINE JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, PerformanceObserverEntryList& impl) { return toJSNewlyCreated(lexicalGlobalObject, globalObject, Ref { impl }); }
