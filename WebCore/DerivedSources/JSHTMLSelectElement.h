...
public:
    ...
    static JSHTMLSelectElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<HTMLSelectElement>&& impl)
    {
        ...
        JSHTMLSelectElement* ptr = new (NotNull, JSC::allocateCell<JSHTMLSelectElement>(vm)) JSHTMLSelectElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<HTMLSelectElement> protectedWrapped() const;
