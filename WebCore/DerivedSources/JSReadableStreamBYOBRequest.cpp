...
static const std::array<HashTableValue, 4> JSReadableStreamBYOBRequestPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsReadableStreamBYOBRequestConstructor, 0 } },
    HashTableValue { "view"_s, JSC::PropertyAttribute::DontEnum | JSC::PropertyAttribute::ReadOnly | JSC::PropertyAttribute::Accessor | JSC::PropertyAttribute::Builtin, NoIntrinsic, { HashTableValue::BuiltinAccessorType, readableStreamBYOBRequestViewCodeGenerator, 0 } },
    HashTableValue { "respond"_s, JSC::PropertyAttribute::DontEnum | JSC::PropertyAttribute::Builtin, NoIntrinsic, { HashTableValue::BuiltinGeneratorType, readableStreamBYOBRequestRespondCodeGenerator, 0 } },
    HashTableValue { "respondWithNewView"_s, JSC::PropertyAttribute::DontEnum | JSC::PropertyAttribute::Builtin, NoIntrinsic, { HashTableValue::BuiltinGeneratorType, readableStreamBYOBRequestRespondWithNewViewCodeGenerator, 0 } },
};
...
{
    return WebCore::subspaceForImpl<JSReadableStreamBYOBRequest, UseCustomHeapCellType::No>(vm, "JSReadableStreamBYOBRequest"_s,
