...
public:
    ...
    static JSSVGTextContentElement* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGTextContentElement>&& impl)
    {
        ...
        JSSVGTextContentElement* ptr = new (NotNull, JSC::allocateCell<JSSVGTextContentElement>(vm)) JSSVGTextContentElement(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGTextContentElement> protectedWrapped() const;
