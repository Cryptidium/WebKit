...
public:
    ...
    static JSSVGPathSegClosePath* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<SVGPathSegClosePath>&& impl)
    {
        ...
        JSSVGPathSegClosePath* ptr = new (NotNull, JSC::allocateCell<JSSVGPathSegClosePath>(vm)) JSSVGPathSegClosePath(structure, *globalObject, WTFMove(impl));
    ...
    Ref<SVGPathSegClosePath> protectedWrapped() const;
