...
public:
    ...
    static JSCSSKeyframeRule* create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<CSSKeyframeRule>&& impl)
    {
        ...
        JSCSSKeyframeRule* ptr = new (NotNull, JSC::allocateCell<JSCSSKeyframeRule>(vm)) JSCSSKeyframeRule(structure, *globalObject, WTFMove(impl));
    ...
    Ref<CSSKeyframeRule> protectedWrapped() const;
